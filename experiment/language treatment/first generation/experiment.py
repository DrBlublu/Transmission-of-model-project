...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\aleblu\\Dropbox\\root\\work\\projects\\2023_transmission_of_model\\experiment\\code\\experiment.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    p_basket_names = [["p_green_basket", "images/p_step2_stim1.png"], ["p_blue_basket", "images/p_step2_stim2.png"]]
    ...
    p_step2_stim1 = {"name": "p_yellow_forest", "file": "images/p_step2_background1.png", "basket_name": p_basket_names[0][0], "basket_file": p_basket_names[0][1], "reward": l_reward[0]}
    p_step2_stim2 = {"name": "p_green_forest", "file": "images/p_step2_background2.png", "basket_name": p_basket_names[1][0], "basket_file": p_basket_names[1][1], "reward": l_reward[1]}
    
    p_step1_stim1 = {"name": "p_pink_gnomes", "file": "images/p_step1_stim1.png", "reward": None, "step2": None, "pair": None, "deact_file": "images/p_step1_stim1_deact.png"}
    p_step1_stim2 = {"name": "p_blue_gnome", "file": "images/p_step1_stim2.png", "reward": None, "step2": None, "pair": None, "deact_file": "images/p_step1_stim2_deact.png"}
    p_step1_stim3 = {"name": "p_green_gnome", "file": "images/p_step1_stim3.png", "reward": None, "step2": None, "pair": None, "deact_file": "images/p_step1_stim3_deact.png"}
    p_step1_stim4 = {"name": "p_orange_gnome", "file": "images/p_step1_stim4.png", "reward": None, "step2": None, "pair": None, "deact_file": "images/p_step1_stim4_deact.png"}
    ...
    basket_names = [["yellow_basket", "images/step2_stim1.png"], ["red_basket", "images/step2_stim2.png"]]
    ...
    t_step2_stim1 = {"name": "bright_forest", "file": "images/step2_background1.png", "basket_name": basket_names[0][0], "basket_file": basket_names[0][1], "reward": l_reward[0]}
    t_step2_stim2 = {"name": "dark_forest", "file": "images/step2_background2.png", "basket_name": basket_names[1][0], "basket_file": basket_names[1][1], "reward": l_reward[1]}
    
    t_step1_stim1 = {"name": "green_gnomes", "file": "images/step1_stim1.png", "reward": None, "step2": None, "pair": None, "deact_file": "images/step1_stim1_deact.png"}
    t_step1_stim2 = {"name": "red_gnome", "file": "images/step1_stim2.png", "reward": None, "step2": None, "pair": None, "deact_file": "images/step1_stim2_deact.png"}
    t_step1_stim3 = {"name": "brown_gnome", "file": "images/step1_stim3.png", "reward": None, "step2": None, "pair": None, "deact_file": "images/step1_stim3_deact.png"}
    t_step1_stim4 = {"name": "purple_gnome", "file": "images/step1_stim4.png", "reward": None, "step2": None, "pair": None, "deact_file": "images/step1_stim4_deact.png"}
    ...
    p_step1_bg_img = visual.ImageStim(
        ...
        image='images/step1_background.png', mask=None, anchor='center',
    ...
    p_step1_highlight_img = visual.ImageStim(
        ...
        image='images/highlight.png', mask=None, anchor='top-center',
    ...
    p_step1_scoreBg_img = visual.ImageStim(
        win=win,
        name='p_step1_scoreBg_img', 
        image='images/grey_rectangle.png', mask=None, anchor='top-center',
        ori=0.0, pos=global_scoreBg_pos, size=global_scoreBg_size,
        color=[0, 0, 0], colorSpace='rgb', opacity=0.9,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=-6.0)
    p_step1_score_txt = visual.TextStim(win=win, name='p_step1_score_txt',
        text='',
        font='Open Sans',
        ...
        languageStyle='LTR',
        depth=-7.0);
    p_step1_unchosenDeact_img = visual.ImageStim(
        win=win,
        name='p_step1_unchosenDeact_img', 
        image='default.png', mask=None, anchor='top-center',
    ...
    p_step2_scoreBg_img = visual.ImageStim(
        win=win,
        name='p_step2_scoreBg_img', 
        image='images/grey_rectangle.png', mask=None, anchor='top-center',
        ori=0.0, pos=global_scoreBg_pos, size=global_scoreBg_size,
        color=[0, 0, 0], colorSpace='rgb', opacity=0.9,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=-5.0)
    p_step2_score_txt = visual.TextStim(win=win, name='p_step2_score_txt',
        text='',
        font='Open Sans',
        pos=global_score_pos, height=global_score_size, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    for thisPractice in practice:
        ...
        p_step1_highlight_flag = False
        p_step1_highlight_pos = [0, 0]
        
        p_step1_deact_flag = False
        p_step1_deact_pos = [0, 0]
        p_step1_deact_img = "images/mush0.png"
        
        p_step1_leftStim_img.setImage(p_step1_stimLeft_var["file"])
        p_step1_rightStim_img.setImage(p_step1_stimRight_var["file"])
        p_step1_score_txt.setText("SCORE: " + str(p_score))
        # keep track of which components have finished
        p_step1Components = [p_step1_bg_img, p_step1_keyresp, p_step1_leftStim_img, p_step1_rightStim_img, p_step1_highlight_img, p_step1_scoreBg_img, p_step1_score_txt, p_step1_unchosenDeact_img]
        ...
        while continueRoutine:
            ...
            # *p_step1_bg_img* updates
            
            # if p_step1_bg_img is starting this frame...
            if p_step1_bg_img.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                p_step1_bg_img.frameNStart = frameN  # exact frame index
                p_step1_bg_img.tStart = t  # local t and not account for scr refresh
                p_step1_bg_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(p_step1_bg_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                p_step1_bg_img.status = STARTED
                p_step1_bg_img.setAutoDraw(True)
            
            # if p_step1_bg_img is active this frame...
            if p_step1_bg_img.status == STARTED:
                # update params
                pass
            
            # if p_step1_bg_img is stopping this frame...
            if p_step1_bg_img.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > p_step1_bg_img.tStartRefresh + 2-frameTolerance:
                    # keep track of stop time/frame for later
                    p_step1_bg_img.tStop = t  # not accounting for scr refresh
                    p_step1_bg_img.frameNStop = frameN  # exact frame index
                    # update status
                    p_step1_bg_img.status = FINISHED
            ...
            if len(p_step1_keyresp.keys) > 0:
                p_step1_highlight_flag = True
                p_step1_deact_flag = True
                if p_step1_keyresp.keys=="s":
                    p_step1_highlight_pos = (-0.5, 0.19)
                    p_step1_deact_img = p_step1_stimLeft_var["deact_file"]
                    p_step1_deact_pos = global_step1_stimLeft_pos
                else:
                    p_step1_highlight_pos = (0.5, 0.19)
                    p_step1_deact_img = p_step1_stimRight_var["deact_file"]
                    p_step1_deact_pos = global_step1_stimRight_pos
            
            # *p_step1_leftStim_img* updates
            
            # if p_step1_leftStim_img is starting this frame...
            if p_step1_leftStim_img.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
                # keep track of start time/frame for later
                p_step1_leftStim_img.frameNStart = frameN  # exact frame index
                p_step1_leftStim_img.tStart = t  # local t and not account for scr refresh
                p_step1_leftStim_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(p_step1_leftStim_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                p_step1_leftStim_img.status = STARTED
                p_step1_leftStim_img.setAutoDraw(True)
            
            # if p_step1_leftStim_img is active this frame...
            if p_step1_leftStim_img.status == STARTED:
                # update params
                pass
            
            # if p_step1_leftStim_img is stopping this frame...
            if p_step1_leftStim_img.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > p_step1_leftStim_img.tStartRefresh + 1.5-frameTolerance:
                    # keep track of stop time/frame for later
                    p_step1_leftStim_img.tStop = t  # not accounting for scr refresh
                    p_step1_leftStim_img.frameNStop = frameN  # exact frame index
                    # update status
                    p_step1_leftStim_img.status = FINISHED
                    p_step1_leftStim_img.setAutoDraw(False)
            
            # *p_step1_rightStim_img* updates
            
            # if p_step1_rightStim_img is starting this frame...
            if p_step1_rightStim_img.status == NOT_STARTED and tThisFlip >= 0.5-frameTolerance:
                # keep track of start time/frame for later
                p_step1_rightStim_img.frameNStart = frameN  # exact frame index
                p_step1_rightStim_img.tStart = t  # local t and not account for scr refresh
                p_step1_rightStim_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(p_step1_rightStim_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                p_step1_rightStim_img.status = STARTED
                p_step1_rightStim_img.setAutoDraw(True)
            
            # if p_step1_rightStim_img is active this frame...
            if p_step1_rightStim_img.status == STARTED:
                # update params
                pass
            
            # if p_step1_rightStim_img is stopping this frame...
            if p_step1_rightStim_img.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > p_step1_rightStim_img.tStartRefresh + 1.5-frameTolerance:
                    # keep track of stop time/frame for later
                    p_step1_rightStim_img.tStop = t  # not accounting for scr refresh
                    p_step1_rightStim_img.frameNStop = frameN  # exact frame index
                    # update status
                    p_step1_rightStim_img.status = FINISHED
                    p_step1_rightStim_img.setAutoDraw(False)
            
            # *p_step1_highlight_img* updates
            
            # if p_step1_highlight_img is starting this frame...
            if p_step1_highlight_img.status == NOT_STARTED and p_step1_highlight_flag:
                # keep track of start time/frame for later
                p_step1_highlight_img.frameNStart = frameN  # exact frame index
                p_step1_highlight_img.tStart = t  # local t and not account for scr refresh
                p_step1_highlight_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(p_step1_highlight_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                p_step1_highlight_img.status = STARTED
                p_step1_highlight_img.setAutoDraw(True)
            
            # if p_step1_highlight_img is active this frame...
            if p_step1_highlight_img.status == STARTED:
                # update params
                p_step1_highlight_img.setPos(p_step1_highlight_pos, log=False)
            
            # *p_step1_scoreBg_img* updates
            
            # if p_step1_scoreBg_img is starting this frame...
            if p_step1_scoreBg_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                p_step1_scoreBg_img.frameNStart = frameN  # exact frame index
                p_step1_scoreBg_img.tStart = t  # local t and not account for scr refresh
                p_step1_scoreBg_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(p_step1_scoreBg_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                p_step1_scoreBg_img.status = STARTED
                p_step1_scoreBg_img.setAutoDraw(True)
            
            # if p_step1_scoreBg_img is active this frame...
            if p_step1_scoreBg_img.status == STARTED:
                # update params
                pass
            
            # *p_step1_score_txt* updates
            
            # if p_step1_score_txt is starting this frame...
            if p_step1_score_txt.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                # keep track of start time/frame for later
                p_step1_score_txt.frameNStart = frameN  # exact frame index
                p_step1_score_txt.tStart = t  # local t and not account for scr refresh
                p_step1_score_txt.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(p_step1_score_txt, 'tStartRefresh')  # time at next scr refresh
                # update status
                p_step1_score_txt.status = STARTED
                p_step1_score_txt.setAutoDraw(True)
            
            # if p_step1_score_txt is active this frame...
            if p_step1_score_txt.status == STARTED:
                # update params
                pass
            
            # if p_step1_score_txt is stopping this frame...
            if p_step1_score_txt.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > p_step1_score_txt.tStartRefresh + 2-frameTolerance:
                    # keep track of stop time/frame for later
                    p_step1_score_txt.tStop = t  # not accounting for scr refresh
                    p_step1_score_txt.frameNStop = frameN  # exact frame index
                    # update status
                    p_step1_score_txt.status = FINISHED
                    p_step1_score_txt.setAutoDraw(False)
            
            # *p_step1_unchosenDeact_img* updates
            
            # if p_step1_unchosenDeact_img is starting this frame...
            if p_step1_unchosenDeact_img.status == NOT_STARTED and p_step1_deact_flag:
                # keep track of start time/frame for later
                p_step1_unchosenDeact_img.frameNStart = frameN  # exact frame index
                p_step1_unchosenDeact_img.tStart = t  # local t and not account for scr refresh
                p_step1_unchosenDeact_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(p_step1_unchosenDeact_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                p_step1_unchosenDeact_img.status = STARTED
                p_step1_unchosenDeact_img.setAutoDraw(True)
            
            # if p_step1_unchosenDeact_img is active this frame...
            if p_step1_unchosenDeact_img.status == STARTED:
                # update params
                p_step1_unchosenDeact_img.setPos(p_step1_deact_pos, log=False)
                p_step1_unchosenDeact_img.setImage(p_step1_deact_img, log=False)
        ...
        # the Routine "p_step1" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        ...
        for thisP_step2_loop in p_step2_loop:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            p_step2_bg_img.setImage(p_step2_stim_var["file"])
            ...
            p_step2_stim_img.setImage(p_step2_stim_var["basket_file"])
            p_step2_score_txt.setText("SCORE: " + str(p_score))
            # keep track of which components have finished
            p_step2Components = [p_step2_bg_img, p_step2_keyresp, p_step2_stim_img, p_step2_highlight_img, p_step2_scoreBg_img, p_step2_score_txt]
            ...
            while continueRoutine:
                ...
                # *p_step2_bg_img* updates
                
                # if p_step2_bg_img is starting this frame...
                if p_step2_bg_img.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                    # keep track of start time/frame for later
                    p_step2_bg_img.frameNStart = frameN  # exact frame index
                    p_step2_bg_img.tStart = t  # local t and not account for scr refresh
                    p_step2_bg_img.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(p_step2_bg_img, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    p_step2_bg_img.status = STARTED
                    p_step2_bg_img.setAutoDraw(True)
                
                # if p_step2_bg_img is active this frame...
                if p_step2_bg_img.status == STARTED:
                    # update params
                    pass
                
                # if p_step2_bg_img is stopping this frame...
                if p_step2_bg_img.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > p_step2_bg_img.tStartRefresh + 1.5-frameTolerance:
                        # keep track of stop time/frame for later
                        p_step2_bg_img.tStop = t  # not accounting for scr refresh
                        p_step2_bg_img.frameNStop = frameN  # exact frame index
                        # update status
                        p_step2_bg_img.status = FINISHED
                ...
                if len(p_step2_keyresp.keys) > 0:
                    p_step2_highlight_flag = True
                
                # *p_step2_stim_img* updates
                
                # if p_step2_stim_img is starting this frame...
                if p_step2_stim_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    p_step2_stim_img.frameNStart = frameN  # exact frame index
                    p_step2_stim_img.tStart = t  # local t and not account for scr refresh
                    p_step2_stim_img.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(p_step2_stim_img, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    p_step2_stim_img.status = STARTED
                    p_step2_stim_img.setAutoDraw(True)
                
                # if p_step2_stim_img is active this frame...
                if p_step2_stim_img.status == STARTED:
                    # update params
                    pass
                
                # if p_step2_stim_img is stopping this frame...
                if p_step2_stim_img.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > p_step2_stim_img.tStartRefresh + 1.5-frameTolerance:
                        # keep track of stop time/frame for later
                        p_step2_stim_img.tStop = t  # not accounting for scr refresh
                        p_step2_stim_img.frameNStop = frameN  # exact frame index
                        # update status
                        p_step2_stim_img.status = FINISHED
                        p_step2_stim_img.setAutoDraw(False)
                
                # *p_step2_highlight_img* updates
                
                # if p_step2_highlight_img is starting this frame...
                if p_step2_highlight_img.status == NOT_STARTED and p_step2_highlight_flag:
                    # keep track of start time/frame for later
                    p_step2_highlight_img.frameNStart = frameN  # exact frame index
                    p_step2_highlight_img.tStart = t  # local t and not account for scr refresh
                    p_step2_highlight_img.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(p_step2_highlight_img, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    p_step2_highlight_img.status = STARTED
                    p_step2_highlight_img.setAutoDraw(True)
                
                # if p_step2_highlight_img is active this frame...
                if p_step2_highlight_img.status == STARTED:
                    # update params
                    p_step2_highlight_img.setPos((0, .05), log=False)
                
                # *p_step2_scoreBg_img* updates
                
                # if p_step2_scoreBg_img is starting this frame...
                if p_step2_scoreBg_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    p_step2_scoreBg_img.frameNStart = frameN  # exact frame index
                    p_step2_scoreBg_img.tStart = t  # local t and not account for scr refresh
                    p_step2_scoreBg_img.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(p_step2_scoreBg_img, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    p_step2_scoreBg_img.status = STARTED
                    p_step2_scoreBg_img.setAutoDraw(True)
                
                # if p_step2_scoreBg_img is active this frame...
                if p_step2_scoreBg_img.status == STARTED:
                    # update params
                    pass
                
                # *p_step2_score_txt* updates
                
                # if p_step2_score_txt is starting this frame...
                if p_step2_score_txt.status == NOT_STARTED and tThisFlip >= 0-frameTolerance:
                    # keep track of start time/frame for later
                    p_step2_score_txt.frameNStart = frameN  # exact frame index
                    p_step2_score_txt.tStart = t  # local t and not account for scr refresh
                    p_step2_score_txt.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(p_step2_score_txt, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    p_step2_score_txt.status = STARTED
                    p_step2_score_txt.setAutoDraw(True)
                
                # if p_step2_score_txt is active this frame...
                if p_step2_score_txt.status == STARTED:
                    # update params
                    pass
                
                # if p_step2_score_txt is stopping this frame...
                if p_step2_score_txt.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > p_step2_score_txt.tStartRefresh + 1.5-frameTolerance:
                        # keep track of stop time/frame for later
                        p_step2_score_txt.tStop = t  # not accounting for scr refresh
                        p_step2_score_txt.frameNStop = frameN  # exact frame index
                        # update status
                        p_step2_score_txt.status = FINISHED
            ...
            if p_step2_keyresp.keys=="space":
                ...
                p_failStep2_flag = 1
                p_points = 0
            # the Routine "p_step2" was not non-slip safe, so reset the non-slip timer
            routineTimer.reset()
        ...
        for thisP_reward_loop in p_reward_loop:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            p_reward_bg_img.setImage(p_step2_stim_var["file"])
            p_reward_step2Stim_img.setImage(p_step2_stim_var["basket_file"])
            ...
            p_reward_mushroom_var = "images/mush" + str(p_points) + ".png"
        ...
        for thisP_failStep1_loop in p_failStep1_loop:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            p_failStep1_leftStim_img.setImage(p_step1_stimLeft_var["deact_file"])
            p_failStep1_rightStim_img.setImage(p_step1_stimRight_var["deact_file"])
        ...
        for thisP_failStep2_loop in p_failStep2_loop:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            p_failStep2_bg_img.setImage(p_step2_stim_var["file"])
            p_failStep2_stim_img.setImage('images/fail_basket.png')
    ...
    for thisTrial in trials:
        ...
        t_step1_deact_img = "images/mush0.png"
        ...
        for thisT_reward_loop in t_reward_loop:
            ...
            t_reward_mushroom_var = "images/mush" + str(t_points) + ".png"
        ...
        for thisT_failStep2_loop in t_failStep2_loop:
            ...
            t_failStep2_stim_img.setImage('images/fail_basket.png')
