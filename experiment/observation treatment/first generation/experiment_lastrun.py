...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\aleblu\\Dropbox\\root\\work\\projects\\2023_transmission_of_model\\experiment\\02 in progress\\first_gen_4pairs\\experiment_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    consent_keyresp = keyboard.Keyboard()
    consent_img = visual.ImageStim(
        win=win,
        name='consent_img', units='norm', 
        image='ressources/consent.png', mask=None, anchor='center',
    ...
    global_instructions1_img = visual.ImageStim(
        win=win,
        name='global_instructions1_img', units='norm', 
        image='ressources/global_instruction_1.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    global_instructions1_key = keyboard.Keyboard()
    
    # --- Initialize components for Routine "global_instructions_2" ---
    global_instructions2_img = visual.ImageStim(
        win=win,
        name='global_instructions2_img', units='norm', 
        image='ressources/global_instruction_2.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    global_instructions2_key = keyboard.Keyboard()
    
    # --- Initialize components for Routine "global_instructions_3" ---
    global_instructions3_img = visual.ImageStim(
        win=win,
        name='global_instructions3_img', units='norm', 
        image='ressources/global_instruction_3.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    global_instructions3_key = keyboard.Keyboard()
    
    # --- Initialize components for Routine "global_instructions_4" ---
    global_instructions4_img = visual.ImageStim(
        win=win,
        name='global_instructions4_img', units='norm', 
        image='ressources/global_instruction_4.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    global_instructions4_key = keyboard.Keyboard()
    
    # --- Initialize components for Routine "global_instructions5" ---
    global_instructions5_img = visual.ImageStim(
        win=win,
        name='global_instructions5_img', units='norm', 
        image='ressources/global_instruction_5.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    global_instructions5_key = keyboard.Keyboard()
    
    # --- Initialize components for Routine "t_countdown" ---
    t_countdown_3_txt = visual.TextStim(win=win, name='t_countdown_3_txt',
        text='3',
        font='Open Sans',
        ...
        languageStyle='LTR',
        depth=0.0);
    t_countdown_2_txt = visual.TextStim(win=win, name='t_countdown_2_txt',
        text='2',
        font='Open Sans',
        pos=(0, 0), height=0.4, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-1.0);
    t_countdown_1_txt = visual.TextStim(win=win, name='t_countdown_1_txt',
        text='1',
        font='Open Sans',
        pos=(0, 0), height=0.4, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    p_fixation_mandatory2_txt = visual.TextStim(win=win, name='p_fixation_mandatory2_txt',
        text=None,
        font='Open Sans',
    ...
    p_reward_mandatory_txt = visual.TextStim(win=win, name='p_reward_mandatory_txt',
        text=None,
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    p_failStep1_mandatory_txt = visual.TextStim(win=win, name='p_failStep1_mandatory_txt',
        text=None,
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-1.0);
    p_failStep1_keyresp = keyboard.Keyboard()
    
    # --- Initialize components for Routine "p_failStep2" ---
    p_failStep2_mandatory_txt = visual.TextStim(win=win, name='p_failStep2_mandatory_txt',
        text=None,
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-1.0);
    p_failStep2_keyresp = keyboard.Keyboard()
    
    # --- Initialize components for Routine "p_data" ---
    
    # --- Initialize components for Routine "t_instructions" ---
    t_instructions_img = visual.ImageStim(
        win=win,
        name='t_instructions_img', units='norm', 
        image='ressources/t_instructions.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    ...
    t_fixation_mandatory_txt = visual.TextStim(win=win, name='t_fixation_mandatory_txt',
        text=None,
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    t_reward_mandatory_txt = visual.TextStim(win=win, name='t_reward_mandatory_txt',
        text=None,
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    t_failStep1_mandatory_txt = visual.TextStim(win=win, name='t_failStep1_mandatory_txt',
        text=None,
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    t_failStep2_mandatory_txt = visual.TextStim(win=win, name='t_failStep2_mandatory_txt',
        text=None,
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
    ...
    pl_global_instructions_img = visual.ImageStim(
        win=win,
        name='pl_global_instructions_img', units='norm', 
        image='ressources/pl_global_instructions.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    pl_global_instructions_keyresp = keyboard.Keyboard()
    
    # --- Initialize components for Routine "vb_instructions" ---
    vb_instructions_img = visual.ImageStim(
        win=win,
        name='vb_instructions_img', units='norm', 
        image='ressources/vb_instructions.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    vb_instructions_keyresp = keyboard.Keyboard()
    ...
    vb_textbox = visual.TextBox2(
         ...
         pos=[-0.85, 0.45],units='height',     letterHeight=0.03,
         ...
         fillColor=[0.8500, 0.8500, 0.8500], borderColor=[-1.0000, -1.0000, -1.0000],
         flipHoriz=False, flipVert=False, languageStyle='LTR',
         editable=True,
         name='vb_textbox',
         depth=0, autoLog=False,
    )
    vb_finished_typing_rect = visual.Rect(
        win=win, name='vb_finished_typing_rect',units='height', 
        width=(0.30, 0.15)[0], height=(0.30, 0.15)[1],
        ori=0.0, pos=[.67, -.35], anchor='center',
        lineWidth=1.0,     colorSpace='rgb',  lineColor=[-1.0000, -1.0000, -1.0000], fillColor=[1.0000, 1.0000, 1.0000],
        opacity=None, depth=-1.0, interpolate=True)
    vb_finished_typing_txt = visual.TextStim(win=win, name='vb_finished_typing_txt',
        text='Click here when you \n    are done typing',
        font='Open Sans',
        units='height', pos=[.67, -.35], height=0.03, wrapWidth=None, ori=0.0, 
        color='black', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-2.0);
    vb_txt = visual.TextStim(win=win, name='vb_txt',
        text='',
        font='Arial',
        ...
        languageStyle='LTR',
        depth=-3.0);
    vb_mouse = event.Mouse(win=win)
    x, y = [None, None]
    vb_mouse.mouseClock = core.Clock()
    
    # --- Initialize components for Routine "pl1_instructions_1" ---
    pl1_instructions1_img = visual.ImageStim(
        win=win,
        name='pl1_instructions1_img', units='norm', 
        image='ressources/pl1_instructions_1.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    pl1_instructions1_keyresp = keyboard.Keyboard()
    
    # --- Initialize components for Routine "pl1_instructions_2" ---
    pl1_instructions2_img = visual.ImageStim(
        win=win,
        name='pl1_instructions2_img', units='norm', 
        image='ressources/pl1_instructions_2.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    pl1_instructions2_keyresp = keyboard.Keyboard()
    
    # --- Initialize components for Routine "pl1_instructions_3" ---
    pl1_instructions3_img = visual.ImageStim(
        win=win,
        name='pl1_instructions3_img', units='norm', 
        image='ressources/pl1_instructions_3.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    pl1_instructions3_keyresp = keyboard.Keyboard()
    
    # --- Initialize components for Routine "pl1_instructions_4" ---
    pl1_instructions4_img = visual.ImageStim(
        win=win,
        name='pl1_instructions4_img', units='norm', 
        image='ressources/pl1_instructions_4.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    pl1_instructions4_keyresp = keyboard.Keyboard()
    ...
    pl1_task_lickert = visual.Slider(win=win, name='pl1_task_lickert',
        startValue=50, size=(1., .05), pos=(0, -.19), units=win.units,
        labels=["0\n(never together)", "100\n(always together)"], ticks=(0, 100), granularity=0.0,
        style='rating', styleTweaks=(), opacity=None,
        labelColor='White', markerColor='Red', lineColor='White', colorSpace='rgb',
        font='Open Sans', labelHeight=0.05,
        flip=True, ori=0.0, depth=0, readOnly=False)
    pl1_task_confidence_lickert = visual.Slider(win=win, name='pl1_task_confidence_lickert',
        startValue=50, size=(1., .05), pos=(0, -.45), units=win.units,
        labels=["0\n(not confident at all)", "100\n(very confident)"], ticks=(0, 100), granularity=0.0,
        style='rating', styleTweaks=(), opacity=None,
        labelColor='White', markerColor='Red', lineColor='White', colorSpace='rgb',
        font='Open Sans', labelHeight=0.05,
        flip=True, ori=0.0, depth=-1, readOnly=False)
    pl1_task_stimLeft_img = visual.ImageStim(
        win=win,
        name='pl1_task_stimLeft_img', 
        image='default.png', mask=None, anchor='bottom-center',
        ori=0.0, pos=pl2_task_stimLeft_pos, size=pl_step1_stim_size,
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=-2.0)
    pl1_task_stimRight_img = visual.ImageStim(
        win=win,
        name='pl1_task_stimRight_img', 
        image='default.png', mask=None, anchor='bottom-center',
    ...
    pl2_instructions_img = visual.ImageStim(
        win=win,
        name='pl2_instructions_img', units='norm', 
        image='ressources/pl2_instructions.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    ...
    pl2_task_lickert = visual.Slider(win=win, name='pl2_task_lickert',
        startValue=50, size=(1., .05), pos=(0, -.19), units=win.units,
        labels=["0\n(never led to)", "100\n(always led to)"], ticks=(0, 100), granularity=0.0,
        style='rating', styleTweaks=(), opacity=None,
        labelColor='White', markerColor='Red', lineColor='White', colorSpace='rgb',
        font='Open Sans', labelHeight=0.05,
        flip=True, ori=0.0, depth=0, readOnly=False)
    pl2_task_confidence_lickert = visual.Slider(win=win, name='pl2_task_confidence_lickert',
        startValue=50, size=(1., .05), pos=(0, -.45), units=win.units,
        labels=["0\n(not confident at all)", "100\n(very confident)"], ticks=(0, 100), granularity=0.0,
        style='rating', styleTweaks=(), opacity=None,
        labelColor='White', markerColor='Red', lineColor='White', colorSpace='rgb',
        font='Open Sans', labelHeight=0.05,
        flip=True, ori=0.0, depth=-1, readOnly=False)
    pl2_task_gnome_img = visual.ImageStim(
        win=win,
        name='pl2_task_gnome_img', 
        image='default.png', mask=None, anchor='bottom-center',
        ori=0.0, pos=pl2_task_stimLeft_pos, size=pl_step1_stim_size,
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    pl2_task_forest_img = visual.ImageStim(
        win=win,
        name='pl2_task_forest_img', 
        image='default.png', mask=None, anchor='bottom-center',
        ori=0.0, pos=pl2_task_stimRight_pos, size=pl2_forest_size,
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=-4.0)
    pl2_task_basket_img = visual.ImageStim(
        win=win,
        name='pl2_task_basket_img', 
        image='default.png', mask=None, anchor='bottom-center',
    ...
    pl3_instructions_img = visual.ImageStim(
        win=win,
        name='pl3_instructions_img', units='norm', 
        image='ressources/pl3_instructions.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    ...
    pl3_task_lickert = visual.Slider(win=win, name='pl3_task_lickert',
        startValue=50, size=(1., .05), pos=(0, (-0.03)), units=win.units,
    ...
    pl3_task_stimLeftBg_img = visual.ImageStim(
        ...
        image='default.png', mask=None, anchor='bottom-center',
        ori=0.0, pos=pl3_step2LeftBg_pos, size=pl_step2Bg_size,
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=-4.0)
    pl3_task_stimRightBg_img = visual.ImageStim(
        ...
        image='default.png', mask=None, anchor='bottom-center',
        ori=0.0, pos=pl3_step2RightBg_pos, size=pl_step2Bg_size,
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=-5.0)
    pl3_task_stimLeft_img = visual.ImageStim(
        ...
        image='default.png', mask=None, anchor='bottom-center',
        ori=0.0, pos=pl3_task_stimLeft_pos, size=pl_basket_size,
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
    ...
    pl3_task_stimRight_img = visual.ImageStim(
        ...
        image='default.png', mask=None, anchor='bottom-center',
        ori=0.0, pos=pl3_task_stimRight_pos, size=pl_basket_size,
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=-7.0)
    pl3_task_confidence_lickert = visual.Slider(win=win, name='pl3_task_confidence_lickert',
        startValue=50, size=(1., .05), pos=(0, -.4), units=win.units,
        labels=[0, 100], ticks=(0, 100), granularity=0.0,
        style='rating', styleTweaks=(), opacity=None,
        labelColor='White', markerColor='Red', lineColor='White', colorSpace='rgb',
        font='Open Sans', labelHeight=0.05,
        flip=True, ori=0.0, depth=-8, readOnly=False)
    pl3_task_confidence_txt = visual.TextStim(win=win, name='pl3_task_confidence_txt',
        text='CONFIDENCE',
        font='Open Sans',
        pos=(0, -.33), height=0.045, wrapWidth=None, ori=0.0, 
        color='White', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
        depth=-9.0);
    ...
    pl4_instructions_img = visual.ImageStim(
        win=win,
        name='pl4_instructions_img', units='norm', 
        image='ressources/pl4_instructions.PNG', mask=None, anchor='center',
        ori=0.0, pos=(0, 0), size=(2, 2),
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=0.0)
    ...
    pl4_task_stimLeft_img = visual.ImageStim(
        ...
        image='default.png', mask=None, anchor='bottom-center',
        ori=0.0, pos=pl3_task_stimLeft_pos, size=pl_step1_stim_size,
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=-4.0)
    pl4_task_stimRight_img = visual.ImageStim(
        ...
        image='default.png', mask=None, anchor='bottom-center',
        ori=0.0, pos=pl3_task_stimRight_pos, size=pl_step1_stim_size,
        color=[1,1,1], colorSpace='rgb', opacity=None,
        flipHoriz=False, flipVert=False,
        texRes=128.0, interpolate=True, depth=-5.0)
    pl4_task_confidence_lickert = visual.Slider(win=win, name='pl4_task_confidence_lickert',
        startValue=50, size=(1., .05), pos=(0, -.4), units=win.units,
        labels=[0, 100], ticks=(0, 100), granularity=0.0,
        style='rating', styleTweaks=(), opacity=None,
        labelColor='White', markerColor='Red', lineColor='White', colorSpace='rgb',
        font='Open Sans', labelHeight=0.05,
        flip=True, ori=0.0, depth=-6, readOnly=False)
    pl4_task_confidence_txt = visual.TextStim(win=win, name='pl4_task_confidence_txt',
        text='CONFIDENCE',
        font='Open Sans',
        pos=(0, -.33), height=0.045, wrapWidth=None, ori=0.0, 
        color='White', colorSpace='rgb', opacity=None, 
    ...
    continueRoutine = True
    # update component parameters for each repeat
    consent_keyresp.keys = []
    consent_keyresp.rt = []
    _consent_keyresp_allKeys = []
    # keep track of which components have finished
    consentComponents = [consent_keyresp, consent_img]
    ...
    while continueRoutine:
        ...
        # if consent_keyresp is starting this frame...
        if consent_keyresp.status == NOT_STARTED and t >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            consent_keyresp.frameNStart = frameN  # exact frame index
            consent_keyresp.tStart = t  # local t and not account for scr refresh
            consent_keyresp.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(consent_keyresp, 'tStartRefresh')  # time at next scr refresh
            # update status
            consent_keyresp.status = STARTED
            # keyboard checking is just starting
            consent_keyresp.clock.reset()  # now t=0
            consent_keyresp.clearEvents(eventType='keyboard')
        if consent_keyresp.status == STARTED:
            theseKeys = consent_keyresp.getKeys(keyList=['y','n'], ignoreKeys=["escape"], waitRelease=False)
            _consent_keyresp_allKeys.extend(theseKeys)
            if len(_consent_keyresp_allKeys):
                consent_keyresp.keys = _consent_keyresp_allKeys[-1].name  # just the last key pressed
                consent_keyresp.rt = _consent_keyresp_allKeys[-1].rt
                consent_keyresp.duration = _consent_keyresp_allKeys[-1].duration
    ...
    for thisComponent in consentComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    # check responses
    if consent_keyresp.keys in ['', [], None]:  # No response was made
        consent_keyresp.keys = None
    thisExp.addData('consent_keyresp.keys',consent_keyresp.keys)
    if consent_keyresp.keys != None:  # we had a response
        thisExp.addData('consent_keyresp.rt', consent_keyresp.rt)
        thisExp.addData('consent_keyresp.duration', consent_keyresp.duration)
    thisExp.nextEntry()
    # the Routine "consent" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    
    # set up handler to look after randomisation of conditions etc
    show_trials = data.TrialHandler(nReps=flag_consent, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
        seed=None, name='show_trials')
    thisExp.addLoop(show_trials)  # add the loop to the experiment
    thisShow_trial = show_trials.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisShow_trial.rgb)
    if thisShow_trial != None:
        for paramName in thisShow_trial:
            globals()[paramName] = thisShow_trial[paramName]
    
    for thisShow_trial in show_trials:
        currentLoop = show_trials
        ...
        continueRoutine = True
        # update component parameters for each repeat
        global_instructions1_key.keys = []
        global_instructions1_key.rt = []
        _global_instructions1_key_allKeys = []
        # keep track of which components have finished
        global_instructions_1Components = [global_instructions1_img, global_instructions1_key]
        for thisComponent in global_instructions_1Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "global_instructions_1" ---
        routineForceEnded = not continueRoutine
        while continueRoutine:
            # get current time
            t = routineTimer.getTime()
            ...
            # if global_instructions1_img is starting this frame...
            if global_instructions1_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                global_instructions1_img.frameNStart = frameN  # exact frame index
                global_instructions1_img.tStart = t  # local t and not account for scr refresh
                global_instructions1_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(global_instructions1_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                global_instructions1_img.status = STARTED
                global_instructions1_img.setAutoDraw(True)
            
            # if global_instructions1_img is active this frame...
            if global_instructions1_img.status == STARTED:
                # update params
                pass
            
            # *global_instructions1_key* updates
            
            # if global_instructions1_key is starting this frame...
            if global_instructions1_key.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                global_instructions1_key.frameNStart = frameN  # exact frame index
                global_instructions1_key.tStart = t  # local t and not account for scr refresh
                global_instructions1_key.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(global_instructions1_key, 'tStartRefresh')  # time at next scr refresh
                # update status
                global_instructions1_key.status = STARTED
                # keyboard checking is just starting
                global_instructions1_key.clock.reset()  # now t=0
                global_instructions1_key.clearEvents(eventType='keyboard')
            if global_instructions1_key.status == STARTED:
                theseKeys = global_instructions1_key.getKeys(keyList=['space'], ignoreKeys=["escape"], waitRelease=False)
                _global_instructions1_key_allKeys.extend(theseKeys)
                if len(_global_instructions1_key_allKeys):
                    global_instructions1_key.keys = _global_instructions1_key_allKeys[-1].name  # just the last key pressed
                    global_instructions1_key.rt = _global_instructions1_key_allKeys[-1].rt
                    global_instructions1_key.duration = _global_instructions1_key_allKeys[-1].duration
                    # a response ends the routine
                    continueRoutine = False
        ...
        for thisComponent in global_instructions_1Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if global_instructions1_key.keys in ['', [], None]:  # No response was made
            global_instructions1_key.keys = None
        show_trials.addData('global_instructions1_key.keys',global_instructions1_key.keys)
        if global_instructions1_key.keys != None:  # we had a response
            show_trials.addData('global_instructions1_key.rt', global_instructions1_key.rt)
            show_trials.addData('global_instructions1_key.duration', global_instructions1_key.duration)
        ...
        continueRoutine = True
        # update component parameters for each repeat
        global_instructions2_key.keys = []
        global_instructions2_key.rt = []
        _global_instructions2_key_allKeys = []
        # keep track of which components have finished
        global_instructions_2Components = [global_instructions2_img, global_instructions2_key]
        for thisComponent in global_instructions_2Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "global_instructions_2" ---
        routineForceEnded = not continueRoutine
        while continueRoutine:
            # get current time
            t = routineTimer.getTime()
            ...
            # if global_instructions2_img is starting this frame...
            if global_instructions2_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                global_instructions2_img.frameNStart = frameN  # exact frame index
                global_instructions2_img.tStart = t  # local t and not account for scr refresh
                global_instructions2_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(global_instructions2_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                global_instructions2_img.status = STARTED
                global_instructions2_img.setAutoDraw(True)
            
            # if global_instructions2_img is active this frame...
            if global_instructions2_img.status == STARTED:
                # update params
                pass
            
            # *global_instructions2_key* updates
            
            # if global_instructions2_key is starting this frame...
            if global_instructions2_key.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                global_instructions2_key.frameNStart = frameN  # exact frame index
                global_instructions2_key.tStart = t  # local t and not account for scr refresh
                global_instructions2_key.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(global_instructions2_key, 'tStartRefresh')  # time at next scr refresh
                # update status
                global_instructions2_key.status = STARTED
                # keyboard checking is just starting
                global_instructions2_key.clock.reset()  # now t=0
                global_instructions2_key.clearEvents(eventType='keyboard')
            if global_instructions2_key.status == STARTED:
                theseKeys = global_instructions2_key.getKeys(keyList=['space'], ignoreKeys=["escape"], waitRelease=False)
                _global_instructions2_key_allKeys.extend(theseKeys)
                if len(_global_instructions2_key_allKeys):
                    global_instructions2_key.keys = _global_instructions2_key_allKeys[-1].name  # just the last key pressed
                    global_instructions2_key.rt = _global_instructions2_key_allKeys[-1].rt
                    global_instructions2_key.duration = _global_instructions2_key_allKeys[-1].duration
                    # a response ends the routine
                    continueRoutine = False
        ...
        for thisComponent in global_instructions_2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if global_instructions2_key.keys in ['', [], None]:  # No response was made
            global_instructions2_key.keys = None
        show_trials.addData('global_instructions2_key.keys',global_instructions2_key.keys)
        if global_instructions2_key.keys != None:  # we had a response
            show_trials.addData('global_instructions2_key.rt', global_instructions2_key.rt)
            show_trials.addData('global_instructions2_key.duration', global_instructions2_key.duration)
        ...
        continueRoutine = True
        # update component parameters for each repeat
        global_instructions3_key.keys = []
        global_instructions3_key.rt = []
        _global_instructions3_key_allKeys = []
        # keep track of which components have finished
        global_instructions_3Components = [global_instructions3_img, global_instructions3_key]
        for thisComponent in global_instructions_3Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "global_instructions_3" ---
        routineForceEnded = not continueRoutine
        while continueRoutine:
            # get current time
            t = routineTimer.getTime()
            ...
            # if global_instructions3_img is starting this frame...
            if global_instructions3_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                global_instructions3_img.frameNStart = frameN  # exact frame index
                global_instructions3_img.tStart = t  # local t and not account for scr refresh
                global_instructions3_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(global_instructions3_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                global_instructions3_img.status = STARTED
                global_instructions3_img.setAutoDraw(True)
            
            # if global_instructions3_img is active this frame...
            if global_instructions3_img.status == STARTED:
                # update params
                pass
            
            # *global_instructions3_key* updates
            
            # if global_instructions3_key is starting this frame...
            if global_instructions3_key.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                global_instructions3_key.frameNStart = frameN  # exact frame index
                global_instructions3_key.tStart = t  # local t and not account for scr refresh
                global_instructions3_key.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(global_instructions3_key, 'tStartRefresh')  # time at next scr refresh
                # update status
                global_instructions3_key.status = STARTED
                # keyboard checking is just starting
                global_instructions3_key.clock.reset()  # now t=0
                global_instructions3_key.clearEvents(eventType='keyboard')
            if global_instructions3_key.status == STARTED:
                theseKeys = global_instructions3_key.getKeys(keyList=['space'], ignoreKeys=["escape"], waitRelease=False)
                _global_instructions3_key_allKeys.extend(theseKeys)
                if len(_global_instructions3_key_allKeys):
                    global_instructions3_key.keys = _global_instructions3_key_allKeys[-1].name  # just the last key pressed
                    global_instructions3_key.rt = _global_instructions3_key_allKeys[-1].rt
                    global_instructions3_key.duration = _global_instructions3_key_allKeys[-1].duration
                    # a response ends the routine
                    continueRoutine = False
        ...
        for thisComponent in global_instructions_3Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if global_instructions3_key.keys in ['', [], None]:  # No response was made
            global_instructions3_key.keys = None
        show_trials.addData('global_instructions3_key.keys',global_instructions3_key.keys)
        if global_instructions3_key.keys != None:  # we had a response
            show_trials.addData('global_instructions3_key.rt', global_instructions3_key.rt)
            show_trials.addData('global_instructions3_key.duration', global_instructions3_key.duration)
        ...
        continueRoutine = True
        # update component parameters for each repeat
        global_instructions4_key.keys = []
        global_instructions4_key.rt = []
        _global_instructions4_key_allKeys = []
        # keep track of which components have finished
        global_instructions_4Components = [global_instructions4_img, global_instructions4_key]
        for thisComponent in global_instructions_4Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "global_instructions_4" ---
        routineForceEnded = not continueRoutine
        while continueRoutine:
            # get current time
            t = routineTimer.getTime()
            ...
            # if global_instructions4_img is starting this frame...
            if global_instructions4_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                global_instructions4_img.frameNStart = frameN  # exact frame index
                global_instructions4_img.tStart = t  # local t and not account for scr refresh
                global_instructions4_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(global_instructions4_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                global_instructions4_img.status = STARTED
                global_instructions4_img.setAutoDraw(True)
            
            # if global_instructions4_img is active this frame...
            if global_instructions4_img.status == STARTED:
                # update params
                pass
            
            # *global_instructions4_key* updates
            
            # if global_instructions4_key is starting this frame...
            if global_instructions4_key.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                global_instructions4_key.frameNStart = frameN  # exact frame index
                global_instructions4_key.tStart = t  # local t and not account for scr refresh
                global_instructions4_key.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(global_instructions4_key, 'tStartRefresh')  # time at next scr refresh
                # update status
                global_instructions4_key.status = STARTED
                # keyboard checking is just starting
                global_instructions4_key.clock.reset()  # now t=0
                global_instructions4_key.clearEvents(eventType='keyboard')
            if global_instructions4_key.status == STARTED:
                theseKeys = global_instructions4_key.getKeys(keyList=['space'], ignoreKeys=["escape"], waitRelease=False)
                _global_instructions4_key_allKeys.extend(theseKeys)
                if len(_global_instructions4_key_allKeys):
                    global_instructions4_key.keys = _global_instructions4_key_allKeys[-1].name  # just the last key pressed
                    global_instructions4_key.rt = _global_instructions4_key_allKeys[-1].rt
                    global_instructions4_key.duration = _global_instructions4_key_allKeys[-1].duration
                    # a response ends the routine
                    continueRoutine = False
        ...
        for thisComponent in global_instructions_4Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if global_instructions4_key.keys in ['', [], None]:  # No response was made
            global_instructions4_key.keys = None
        show_trials.addData('global_instructions4_key.keys',global_instructions4_key.keys)
        if global_instructions4_key.keys != None:  # we had a response
            show_trials.addData('global_instructions4_key.rt', global_instructions4_key.rt)
            show_trials.addData('global_instructions4_key.duration', global_instructions4_key.duration)
        ...
        continueRoutine = True
        # update component parameters for each repeat
        global_instructions5_key.keys = []
        global_instructions5_key.rt = []
        _global_instructions5_key_allKeys = []
        # keep track of which components have finished
        global_instructions5Components = [global_instructions5_img, global_instructions5_key]
        for thisComponent in global_instructions5Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "global_instructions5" ---
        routineForceEnded = not continueRoutine
        while continueRoutine:
            # get current time
            t = routineTimer.getTime()
            ...
            # if global_instructions5_img is starting this frame...
            if global_instructions5_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                global_instructions5_img.frameNStart = frameN  # exact frame index
                global_instructions5_img.tStart = t  # local t and not account for scr refresh
                global_instructions5_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(global_instructions5_img, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'global_instructions5_img.started')
                # update status
                global_instructions5_img.status = STARTED
                global_instructions5_img.setAutoDraw(True)
            
            # if global_instructions5_img is active this frame...
            if global_instructions5_img.status == STARTED:
                # update params
                pass
            
            # *global_instructions5_key* updates
            
            # if global_instructions5_key is starting this frame...
            if global_instructions5_key.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                global_instructions5_key.frameNStart = frameN  # exact frame index
                global_instructions5_key.tStart = t  # local t and not account for scr refresh
                global_instructions5_key.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(global_instructions5_key, 'tStartRefresh')  # time at next scr refresh
                # update status
                global_instructions5_key.status = STARTED
                # keyboard checking is just starting
                global_instructions5_key.clock.reset()  # now t=0
                global_instructions5_key.clearEvents(eventType='keyboard')
            if global_instructions5_key.status == STARTED:
                theseKeys = global_instructions5_key.getKeys(keyList=['space'], ignoreKeys=["escape"], waitRelease=False)
                _global_instructions5_key_allKeys.extend(theseKeys)
                if len(_global_instructions5_key_allKeys):
                    global_instructions5_key.keys = _global_instructions5_key_allKeys[-1].name  # just the last key pressed
                    global_instructions5_key.rt = _global_instructions5_key_allKeys[-1].rt
                    global_instructions5_key.duration = _global_instructions5_key_allKeys[-1].duration
                    # a response ends the routine
                    continueRoutine = False
        ...
        for thisComponent in global_instructions5Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if global_instructions5_key.keys in ['', [], None]:  # No response was made
            global_instructions5_key.keys = None
        show_trials.addData('global_instructions5_key.keys',global_instructions5_key.keys)
        if global_instructions5_key.keys != None:  # we had a response
            show_trials.addData('global_instructions5_key.rt', global_instructions5_key.rt)
            show_trials.addData('global_instructions5_key.duration', global_instructions5_key.duration)
        ...
        # update component parameters for each repeat
        # keep track of which components have finished
        t_countdownComponents = [t_countdown_3_txt, t_countdown_2_txt, t_countdown_1_txt]
        for thisComponent in t_countdownComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine and routineTimer.getTime() < 1.5:
            ...
            # if t_countdown_3_txt is starting this frame...
            if t_countdown_3_txt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                t_countdown_3_txt.frameNStart = frameN  # exact frame index
                t_countdown_3_txt.tStart = t  # local t and not account for scr refresh
                t_countdown_3_txt.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(t_countdown_3_txt, 'tStartRefresh')  # time at next scr refresh
                # update status
                t_countdown_3_txt.status = STARTED
                t_countdown_3_txt.setAutoDraw(True)
            
            # if t_countdown_3_txt is active this frame...
            if t_countdown_3_txt.status == STARTED:
                # update params
                pass
            
            # if t_countdown_3_txt is stopping this frame...
            if t_countdown_3_txt.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > t_countdown_3_txt.tStartRefresh + .5-frameTolerance:
                    # keep track of stop time/frame for later
                    t_countdown_3_txt.tStop = t  # not accounting for scr refresh
                    t_countdown_3_txt.frameNStop = frameN  # exact frame index
                    # update status
                    t_countdown_3_txt.status = FINISHED
                    t_countdown_3_txt.setAutoDraw(False)
            
            # *t_countdown_2_txt* updates
            
            # if t_countdown_2_txt is starting this frame...
            if t_countdown_2_txt.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                # keep track of start time/frame for later
                t_countdown_2_txt.frameNStart = frameN  # exact frame index
                t_countdown_2_txt.tStart = t  # local t and not account for scr refresh
                t_countdown_2_txt.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(t_countdown_2_txt, 'tStartRefresh')  # time at next scr refresh
                # update status
                t_countdown_2_txt.status = STARTED
                t_countdown_2_txt.setAutoDraw(True)
            
            # if t_countdown_2_txt is active this frame...
            if t_countdown_2_txt.status == STARTED:
                # update params
                pass
            
            # if t_countdown_2_txt is stopping this frame...
            if t_countdown_2_txt.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > t_countdown_2_txt.tStartRefresh + .5-frameTolerance:
                    # keep track of stop time/frame for later
                    t_countdown_2_txt.tStop = t  # not accounting for scr refresh
                    t_countdown_2_txt.frameNStop = frameN  # exact frame index
                    # update status
                    t_countdown_2_txt.status = FINISHED
                    t_countdown_2_txt.setAutoDraw(False)
            
            # *t_countdown_1_txt* updates
            
            # if t_countdown_1_txt is starting this frame...
            if t_countdown_1_txt.status == NOT_STARTED and tThisFlip >= 1-frameTolerance:
                # keep track of start time/frame for later
                t_countdown_1_txt.frameNStart = frameN  # exact frame index
                t_countdown_1_txt.tStart = t  # local t and not account for scr refresh
                t_countdown_1_txt.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(t_countdown_1_txt, 'tStartRefresh')  # time at next scr refresh
                # update status
                t_countdown_1_txt.status = STARTED
                t_countdown_1_txt.setAutoDraw(True)
            
            # if t_countdown_1_txt is active this frame...
            if t_countdown_1_txt.status == STARTED:
                # update params
                pass
            
            # if t_countdown_1_txt is stopping this frame...
            if t_countdown_1_txt.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > t_countdown_1_txt.tStartRefresh + .5-frameTolerance:
                    # keep track of stop time/frame for later
                    t_countdown_1_txt.tStop = t  # not accounting for scr refresh
                    t_countdown_1_txt.frameNStop = frameN  # exact frame index
                    # update status
                    t_countdown_1_txt.status = FINISHED
        ...
        for thisPractice in practice:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            thisExp.addData('p_fixation_2.started', globalClock.getTime())
            # keep track of which components have finished
            p_fixation_2Components = [p_fixation_mandatory2_txt]
            for thisComponent in p_fixation_2Components:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            while continueRoutine:
                ...
                # if p_fixation_mandatory2_txt is starting this frame...
                if p_fixation_mandatory2_txt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    p_fixation_mandatory2_txt.frameNStart = frameN  # exact frame index
                    p_fixation_mandatory2_txt.tStart = t  # local t and not account for scr refresh
                    p_fixation_mandatory2_txt.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(p_fixation_mandatory2_txt, 'tStartRefresh')  # time at next scr refresh
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'p_fixation_mandatory2_txt.started')
                    # update status
                    p_fixation_mandatory2_txt.status = STARTED
                    p_fixation_mandatory2_txt.setAutoDraw(True)
                
                # if p_fixation_mandatory2_txt is active this frame...
                if p_fixation_mandatory2_txt.status == STARTED:
                    # update params
                    pass
            ...
            for thisComponent in p_fixation_2Components:
                if hasattr(thisComponent, "setAutoDraw"):
                    thisComponent.setAutoDraw(False)
            thisExp.addData('p_fixation_2.stopped', globalClock.getTime())
            ...
            while continueRoutine and routineTimer.getTime() < 1.5:
                ...
                if p_step1_keyresp.status == NOT_STARTED and t >= 0-frameTolerance:
                    # keep track of start time/frame for later
            ...
            for thisP_step2_loop in p_step2_loop:
                ...
                p_reward_mushroom_img = visual.ImageStim(
                    ...
                    image = (("ressources/mush" + p_points.toString()) + ".png"),
                    mask = undefined,
                    anchor = 'top-center',
            ...
            for thisP_reward_loop in p_reward_loop:
                ...
                # keep track of which components have finished
                p_rewardComponents = [p_reward_mandatory_txt]
                ...
                while continueRoutine:
                    ...
                    # if p_reward_mandatory_txt is starting this frame...
                    if p_reward_mandatory_txt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        p_reward_mandatory_txt.frameNStart = frameN  # exact frame index
                        p_reward_mandatory_txt.tStart = t  # local t and not account for scr refresh
                        p_reward_mandatory_txt.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(p_reward_mandatory_txt, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'p_reward_mandatory_txt.started')
                        # update status
                        p_reward_mandatory_txt.status = STARTED
                        p_reward_mandatory_txt.setAutoDraw(True)
                    
                    # if p_reward_mandatory_txt is active this frame...
                    if p_reward_mandatory_txt.status == STARTED:
                        # update params
                        pass
            ...
            for thisP_failStep1_loop in p_failStep1_loop:
                ...
                p_failStep1_keyresp.keys = []
                p_failStep1_keyresp.rt = []
                _p_failStep1_keyresp_allKeys = []
                # keep track of which components have finished
                p_failStep1Components = [p_failStep1_mandatory_txt, p_failStep1_keyresp]
                ...
                while continueRoutine:
                    ...
                    # if p_failStep1_mandatory_txt is starting this frame...
                    if p_failStep1_mandatory_txt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        p_failStep1_mandatory_txt.frameNStart = frameN  # exact frame index
                        p_failStep1_mandatory_txt.tStart = t  # local t and not account for scr refresh
                        p_failStep1_mandatory_txt.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(p_failStep1_mandatory_txt, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'p_failStep1_mandatory_txt.started')
                        # update status
                        p_failStep1_mandatory_txt.status = STARTED
                        p_failStep1_mandatory_txt.setAutoDraw(True)
                    
                    # if p_failStep1_mandatory_txt is active this frame...
                    if p_failStep1_mandatory_txt.status == STARTED:
                        # update params
                        pass
                    
                    # *p_failStep1_keyresp* updates
                    
                    # if p_failStep1_keyresp is starting this frame...
                    if p_failStep1_keyresp.status == NOT_STARTED and t >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        p_failStep1_keyresp.frameNStart = frameN  # exact frame index
                        p_failStep1_keyresp.tStart = t  # local t and not account for scr refresh
                        p_failStep1_keyresp.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(p_failStep1_keyresp, 'tStartRefresh')  # time at next scr refresh
                        # update status
                        p_failStep1_keyresp.status = STARTED
                        # keyboard checking is just starting
                        p_failStep1_keyresp.clock.reset()  # now t=0
                        p_failStep1_keyresp.clearEvents(eventType='keyboard')
                    if p_failStep1_keyresp.status == STARTED:
                        theseKeys = p_failStep1_keyresp.getKeys(keyList=['space'], ignoreKeys=["escape"], waitRelease=False)
                        _p_failStep1_keyresp_allKeys.extend(theseKeys)
                        if len(_p_failStep1_keyresp_allKeys):
                            p_failStep1_keyresp.keys = _p_failStep1_keyresp_allKeys[-1].name  # just the last key pressed
                            p_failStep1_keyresp.rt = _p_failStep1_keyresp_allKeys[-1].rt
                            p_failStep1_keyresp.duration = _p_failStep1_keyresp_allKeys[-1].duration
                            # a response ends the routine
                            continueRoutine = False
                ...
                # check responses
                if p_failStep1_keyresp.keys in ['', [], None]:  # No response was made
                    p_failStep1_keyresp.keys = None
                p_failStep1_loop.addData('p_failStep1_keyresp.keys',p_failStep1_keyresp.keys)
                if p_failStep1_keyresp.keys != None:  # we had a response
                    p_failStep1_loop.addData('p_failStep1_keyresp.rt', p_failStep1_keyresp.rt)
                    p_failStep1_loop.addData('p_failStep1_keyresp.duration', p_failStep1_keyresp.duration)
            ...
            for thisP_failStep2_loop in p_failStep2_loop:
                ...
                p_failStep2_keyresp.keys = []
                p_failStep2_keyresp.rt = []
                _p_failStep2_keyresp_allKeys = []
                # keep track of which components have finished
                p_failStep2Components = [p_failStep2_mandatory_txt, p_failStep2_keyresp]
                ...
                while continueRoutine:
                    ...
                    # if p_failStep2_mandatory_txt is starting this frame...
                    if p_failStep2_mandatory_txt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        p_failStep2_mandatory_txt.frameNStart = frameN  # exact frame index
                        p_failStep2_mandatory_txt.tStart = t  # local t and not account for scr refresh
                        p_failStep2_mandatory_txt.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(p_failStep2_mandatory_txt, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 'p_failStep2_mandatory_txt.started')
                        # update status
                        p_failStep2_mandatory_txt.status = STARTED
                        p_failStep2_mandatory_txt.setAutoDraw(True)
                    
                    # if p_failStep2_mandatory_txt is active this frame...
                    if p_failStep2_mandatory_txt.status == STARTED:
                        # update params
                        pass
                    
                    # *p_failStep2_keyresp* updates
                    
                    # if p_failStep2_keyresp is starting this frame...
                    if p_failStep2_keyresp.status == NOT_STARTED and t >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        p_failStep2_keyresp.frameNStart = frameN  # exact frame index
                        p_failStep2_keyresp.tStart = t  # local t and not account for scr refresh
                        p_failStep2_keyresp.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(p_failStep2_keyresp, 'tStartRefresh')  # time at next scr refresh
                        # update status
                        p_failStep2_keyresp.status = STARTED
                        # keyboard checking is just starting
                        p_failStep2_keyresp.clock.reset()  # now t=0
                        p_failStep2_keyresp.clearEvents(eventType='keyboard')
                    if p_failStep2_keyresp.status == STARTED:
                        theseKeys = p_failStep2_keyresp.getKeys(keyList=['space'], ignoreKeys=["escape"], waitRelease=False)
                        _p_failStep2_keyresp_allKeys.extend(theseKeys)
                        if len(_p_failStep2_keyresp_allKeys):
                            p_failStep2_keyresp.keys = _p_failStep2_keyresp_allKeys[-1].name  # just the last key pressed
                            p_failStep2_keyresp.rt = _p_failStep2_keyresp_allKeys[-1].rt
                            p_failStep2_keyresp.duration = _p_failStep2_keyresp_allKeys[-1].duration
                            # a response ends the routine
                            continueRoutine = False
                ...
                # check responses
                if p_failStep2_keyresp.keys in ['', [], None]:  # No response was made
                    p_failStep2_keyresp.keys = None
                p_failStep2_loop.addData('p_failStep2_keyresp.keys',p_failStep2_keyresp.keys)
                if p_failStep2_keyresp.keys != None:  # we had a response
                    p_failStep2_loop.addData('p_failStep2_keyresp.rt', p_failStep2_keyresp.rt)
                    p_failStep2_loop.addData('p_failStep2_keyresp.duration', p_failStep2_keyresp.duration)
        ...
        # keep track of which components have finished
        t_instructionsComponents = [t_instructions_img, t_instructions_keyresp]
        ...
        while continueRoutine:
            ...
            # if t_instructions_img is starting this frame...
            if t_instructions_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                t_instructions_img.frameNStart = frameN  # exact frame index
                t_instructions_img.tStart = t  # local t and not account for scr refresh
                t_instructions_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(t_instructions_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                t_instructions_img.status = STARTED
                t_instructions_img.setAutoDraw(True)
            
            # if t_instructions_img is active this frame...
            if t_instructions_img.status == STARTED:
                # update params
                pass
        ...
        show_trials.addData('t_instructions_keyresp.keys',t_instructions_keyresp.keys)
        if t_instructions_keyresp.keys != None:  # we had a response
            show_trials.addData('t_instructions_keyresp.rt', t_instructions_keyresp.rt)
            show_trials.addData('t_instructions_keyresp.duration', t_instructions_keyresp.duration)
        ...
        # set up handler to look after randomisation of conditions etc
        trials = data.TrialHandler(nReps=64.0, method='fullRandom', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('trials_pairIndex.csv'),
        ...
        for thisTrial in trials:
            ...
            # update component parameters for each repeat
            # keep track of which components have finished
            t_fixationComponents = [t_fixation_mandatory_txt]
            for thisComponent in t_fixationComponents:
                thisComponent.tStart = None
                thisComponent.tStop = None
                thisComponent.tStartRefresh = None
                thisComponent.tStopRefresh = None
            ...
            while continueRoutine:
                ...
                # if t_fixation_mandatory_txt is starting this frame...
                if t_fixation_mandatory_txt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                    # keep track of start time/frame for later
                    t_fixation_mandatory_txt.frameNStart = frameN  # exact frame index
                    t_fixation_mandatory_txt.tStart = t  # local t and not account for scr refresh
                    t_fixation_mandatory_txt.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(t_fixation_mandatory_txt, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    t_fixation_mandatory_txt.status = STARTED
                    t_fixation_mandatory_txt.setAutoDraw(True)
                
                # if t_fixation_mandatory_txt is active this frame...
                if t_fixation_mandatory_txt.status == STARTED:
                    # update params
                    pass
            ...
            # keep track of which components have finished
            t_step1Components = [t_step1_keyresp]
            ...
            while continueRoutine and routineTimer.getTime() < 1.5:
                ...
                if t_step1_keyresp.status == NOT_STARTED and t >= 0-frameTolerance:
                    # keep track of start time/frame for later
                ...
                if t_step1_keyresp.status == STARTED:
                    # is it time to stop? (based on global clock, using actual start)
                    if tThisFlipGlobal > t_step1_keyresp.tStartRefresh + 2-frameTolerance:
                        # keep track of stop time/frame for later
            ...
            for thisT_step2_loop in t_step2_loop:
                ...
                # keep track of which components have finished
                t_step2Components = [t_step2_keyresp]
            ...
            for thisT_reward_loop in t_reward_loop:
                ...
                # keep track of which components have finished
                t_rewardComponents = [t_reward_mandatory_txt]
                ...
                while continueRoutine:
                    ...
                    # if t_reward_mandatory_txt is starting this frame...
                    if t_reward_mandatory_txt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        t_reward_mandatory_txt.frameNStart = frameN  # exact frame index
                        t_reward_mandatory_txt.tStart = t  # local t and not account for scr refresh
                        t_reward_mandatory_txt.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(t_reward_mandatory_txt, 'tStartRefresh')  # time at next scr refresh
                        # update status
                        t_reward_mandatory_txt.status = STARTED
                        t_reward_mandatory_txt.setAutoDraw(True)
                    
                    # if t_reward_mandatory_txt is active this frame...
                    if t_reward_mandatory_txt.status == STARTED:
                        # update params
                        pass
            ...
            for thisT_failStep1_loop in t_failStep1_loop:
                ...
                # update component parameters for each repeat
                # keep track of which components have finished
                t_failStep1Components = [t_failStep1_mandatory_txt]
                ...
                while continueRoutine:
                    ...
                    # if t_failStep1_mandatory_txt is starting this frame...
                    if t_failStep1_mandatory_txt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        t_failStep1_mandatory_txt.frameNStart = frameN  # exact frame index
                        t_failStep1_mandatory_txt.tStart = t  # local t and not account for scr refresh
                        t_failStep1_mandatory_txt.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(t_failStep1_mandatory_txt, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 't_failStep1_mandatory_txt.started')
                        # update status
                        t_failStep1_mandatory_txt.status = STARTED
                        t_failStep1_mandatory_txt.setAutoDraw(True)
                    
                    # if t_failStep1_mandatory_txt is active this frame...
                    if t_failStep1_mandatory_txt.status == STARTED:
                        # update params
                        pass
            ...
            for thisT_failStep2_loop in t_failStep2_loop:
                ...
                # update component parameters for each repeat
                # keep track of which components have finished
                t_failStep2Components = [t_failStep2_mandatory_txt]
                ...
                while continueRoutine:
                    ...
                    # if t_failStep2_mandatory_txt is starting this frame...
                    if t_failStep2_mandatory_txt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                        # keep track of start time/frame for later
                        t_failStep2_mandatory_txt.frameNStart = frameN  # exact frame index
                        t_failStep2_mandatory_txt.tStart = t  # local t and not account for scr refresh
                        t_failStep2_mandatory_txt.tStartRefresh = tThisFlipGlobal  # on global time
                        win.timeOnFlip(t_failStep2_mandatory_txt, 'tStartRefresh')  # time at next scr refresh
                        # add timestamp to datafile
                        thisExp.timestampOnFlip(win, 't_failStep2_mandatory_txt.started')
                        # update status
                        t_failStep2_mandatory_txt.status = STARTED
                        t_failStep2_mandatory_txt.setAutoDraw(True)
                    
                    # if t_failStep2_mandatory_txt is active this frame...
                    if t_failStep2_mandatory_txt.status == STARTED:
                        # update params
                        pass
            ...
            thisExp.addData("t_step1_stimLeft_reward", t_step1_stimLeft_var["step2"]["reward"])
            ...
            thisExp.addData("t_step1_stimRight_reward", t_step1_stimRight_var["step2"]["reward"])
            ...
            for i in range(len(l_t_step2_stims)):
            ...
            if thisSession is not None:
                # if running in a Session with a Liaison client, send data up to now
                thisSession.sendExperimentData()
        # completed 64.0 repeats of 'trials'
        
        
        # --- Prepare to start Routine "pl_global_instructions" ---
        continueRoutine = True
        # update component parameters for each repeat
        pl_global_instructions_keyresp.keys = []
        pl_global_instructions_keyresp.rt = []
        _pl_global_instructions_keyresp_allKeys = []
        # keep track of which components have finished
        pl_global_instructionsComponents = [pl_global_instructions_img, pl_global_instructions_keyresp]
        for thisComponent in pl_global_instructionsComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "pl_global_instructions" ---
        routineForceEnded = not continueRoutine
        while continueRoutine:
            # get current time
            t = routineTimer.getTime()
            ...
            # if pl_global_instructions_img is starting this frame...
            if pl_global_instructions_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl_global_instructions_img.frameNStart = frameN  # exact frame index
                pl_global_instructions_img.tStart = t  # local t and not account for scr refresh
                pl_global_instructions_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl_global_instructions_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl_global_instructions_img.status = STARTED
                pl_global_instructions_img.setAutoDraw(True)
            
            # if pl_global_instructions_img is active this frame...
            if pl_global_instructions_img.status == STARTED:
                # update params
                pass
            
            # *pl_global_instructions_keyresp* updates
            
            # if pl_global_instructions_keyresp is starting this frame...
            if pl_global_instructions_keyresp.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl_global_instructions_keyresp.frameNStart = frameN  # exact frame index
                pl_global_instructions_keyresp.tStart = t  # local t and not account for scr refresh
                pl_global_instructions_keyresp.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl_global_instructions_keyresp, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl_global_instructions_keyresp.status = STARTED
                # keyboard checking is just starting
                pl_global_instructions_keyresp.clock.reset()  # now t=0
                pl_global_instructions_keyresp.clearEvents(eventType='keyboard')
            if pl_global_instructions_keyresp.status == STARTED:
                theseKeys = pl_global_instructions_keyresp.getKeys(keyList=['space'], ignoreKeys=["escape"], waitRelease=False)
                _pl_global_instructions_keyresp_allKeys.extend(theseKeys)
                if len(_pl_global_instructions_keyresp_allKeys):
                    pl_global_instructions_keyresp.keys = _pl_global_instructions_keyresp_allKeys[-1].name  # just the last key pressed
                    pl_global_instructions_keyresp.rt = _pl_global_instructions_keyresp_allKeys[-1].rt
                    pl_global_instructions_keyresp.duration = _pl_global_instructions_keyresp_allKeys[-1].duration
                    # a response ends the routine
                    continueRoutine = False
        ...
        for thisComponent in pl_global_instructionsComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if pl_global_instructions_keyresp.keys in ['', [], None]:  # No response was made
            pl_global_instructions_keyresp.keys = None
        show_trials.addData('pl_global_instructions_keyresp.keys',pl_global_instructions_keyresp.keys)
        if pl_global_instructions_keyresp.keys != None:  # we had a response
            show_trials.addData('pl_global_instructions_keyresp.rt', pl_global_instructions_keyresp.rt)
            show_trials.addData('pl_global_instructions_keyresp.duration', pl_global_instructions_keyresp.duration)
        ...
        continueRoutine = True
        # update component parameters for each repeat
        vb_instructions_keyresp.keys = []
        vb_instructions_keyresp.rt = []
        _vb_instructions_keyresp_allKeys = []
        # keep track of which components have finished
        vb_instructionsComponents = [vb_instructions_img, vb_instructions_keyresp]
        for thisComponent in vb_instructionsComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine:
            ...
            # if vb_instructions_img is starting this frame...
            if vb_instructions_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                vb_instructions_img.frameNStart = frameN  # exact frame index
                vb_instructions_img.tStart = t  # local t and not account for scr refresh
                vb_instructions_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(vb_instructions_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                vb_instructions_img.status = STARTED
                vb_instructions_img.setAutoDraw(True)
            
            # if vb_instructions_img is active this frame...
            if vb_instructions_img.status == STARTED:
                # update params
                pass
            
            # *vb_instructions_keyresp* updates
            
            # if vb_instructions_keyresp is starting this frame...
            if vb_instructions_keyresp.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                vb_instructions_keyresp.frameNStart = frameN  # exact frame index
                vb_instructions_keyresp.tStart = t  # local t and not account for scr refresh
                vb_instructions_keyresp.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(vb_instructions_keyresp, 'tStartRefresh')  # time at next scr refresh
                # update status
                vb_instructions_keyresp.status = STARTED
                # keyboard checking is just starting
                vb_instructions_keyresp.clock.reset()  # now t=0
                vb_instructions_keyresp.clearEvents(eventType='keyboard')
            if vb_instructions_keyresp.status == STARTED:
                theseKeys = vb_instructions_keyresp.getKeys(keyList=['space'], ignoreKeys=["escape"], waitRelease=False)
                _vb_instructions_keyresp_allKeys.extend(theseKeys)
                if len(_vb_instructions_keyresp_allKeys):
                    vb_instructions_keyresp.keys = _vb_instructions_keyresp_allKeys[-1].name  # just the last key pressed
                    vb_instructions_keyresp.rt = _vb_instructions_keyresp_allKeys[-1].rt
                    vb_instructions_keyresp.duration = _vb_instructions_keyresp_allKeys[-1].duration
                    # a response ends the routine
                    continueRoutine = False
        ...
        for thisComponent in vb_instructionsComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if vb_instructions_keyresp.keys in ['', [], None]:  # No response was made
            vb_instructions_keyresp.keys = None
        show_trials.addData('vb_instructions_keyresp.keys',vb_instructions_keyresp.keys)
        if vb_instructions_keyresp.keys != None:  # we had a response
            show_trials.addData('vb_instructions_keyresp.rt', vb_instructions_keyresp.rt)
            show_trials.addData('vb_instructions_keyresp.duration', vb_instructions_keyresp.duration)
        ...
        # keep track of which components have finished
        verbal_transmissionComponents = [vb_textbox, vb_finished_typing_rect, vb_finished_typing_txt, vb_txt, vb_mouse]
        ...
        while continueRoutine:
            ...
            # if vb_finished_typing_rect is starting this frame...
            if vb_finished_typing_rect.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                vb_finished_typing_rect.frameNStart = frameN  # exact frame index
                vb_finished_typing_rect.tStart = t  # local t and not account for scr refresh
                vb_finished_typing_rect.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(vb_finished_typing_rect, 'tStartRefresh')  # time at next scr refresh
                # update status
                vb_finished_typing_rect.status = STARTED
                vb_finished_typing_rect.setAutoDraw(True)
            
            # if vb_finished_typing_rect is active this frame...
            if vb_finished_typing_rect.status == STARTED:
                # update params
                pass
            
            # *vb_finished_typing_txt* updates
            
            # if vb_finished_typing_txt is starting this frame...
            if vb_finished_typing_txt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                vb_finished_typing_txt.frameNStart = frameN  # exact frame index
                vb_finished_typing_txt.tStart = t  # local t and not account for scr refresh
                vb_finished_typing_txt.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(vb_finished_typing_txt, 'tStartRefresh')  # time at next scr refresh
                # update status
                vb_finished_typing_txt.status = STARTED
                vb_finished_typing_txt.setAutoDraw(True)
            
            # if vb_finished_typing_txt is active this frame...
            if vb_finished_typing_txt.status == STARTED:
                # update params
                pass
            
            # *vb_txt* updates
            
            # if vb_txt is starting this frame...
            if vb_txt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                vb_txt.frameNStart = frameN  # exact frame index
                vb_txt.tStart = t  # local t and not account for scr refresh
                vb_txt.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(vb_txt, 'tStartRefresh')  # time at next scr refresh
                # update status
                vb_txt.status = STARTED
                vb_txt.setAutoDraw(True)
            
            # if vb_txt is active this frame...
            if vb_txt.status == STARTED:
                # update params
                vb_txt.setText(chr_counter, log=False)
            # *vb_mouse* updates
            
            # if vb_mouse is starting this frame...
            if vb_mouse.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                vb_mouse.frameNStart = frameN  # exact frame index
                vb_mouse.tStart = t  # local t and not account for scr refresh
                vb_mouse.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(vb_mouse, 'tStartRefresh')  # time at next scr refresh
                # update status
                vb_mouse.status = STARTED
                vb_mouse.mouseClock.reset()
                prevButtonState = vb_mouse.getPressed()  # if button is down already this ISN'T a new click
            if vb_mouse.status == STARTED:  # only update if started and not finished!
                buttons = vb_mouse.getPressed()
                if buttons != prevButtonState:  # button state changed?
                    prevButtonState = buttons
                    if sum(buttons) > 0:  # state changed to a new click
                        # check if the mouse was inside our 'clickable' objects
                        gotValidClick = False
                        clickableList = environmenttools.getFromNames(vb_finished_typing_rect, namespace=locals())
                        for obj in clickableList:
                            # is this object clicked on?
                            if obj.contains(vb_mouse):
                                gotValidClick = True
                                vb_mouse.clicked_name.append(obj.name)
                        x, y = vb_mouse.getPos()
                        vb_mouse.x.append(x)
                        vb_mouse.y.append(y)
                        buttons = vb_mouse.getPressed()
                        vb_mouse.leftButton.append(buttons[0])
                        vb_mouse.midButton.append(buttons[1])
                        vb_mouse.rightButton.append(buttons[2])
                        vb_mouse.time.append(vb_mouse.mouseClock.getTime())
                        if gotValidClick:
        ...
        for thisComponent in verbal_transmissionComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        show_trials.addData('vb_textbox.text',vb_textbox.text)
        # store data for show_trials (TrialHandler)
        show_trials.addData('vb_mouse.x', vb_mouse.x)
        show_trials.addData('vb_mouse.y', vb_mouse.y)
        show_trials.addData('vb_mouse.leftButton', vb_mouse.leftButton)
        show_trials.addData('vb_mouse.midButton', vb_mouse.midButton)
        show_trials.addData('vb_mouse.rightButton', vb_mouse.rightButton)
        show_trials.addData('vb_mouse.time', vb_mouse.time)
        show_trials.addData('vb_mouse.clicked_name', vb_mouse.clicked_name)
        ...
        continueRoutine = True
        # update component parameters for each repeat
        pl1_instructions1_keyresp.keys = []
        pl1_instructions1_keyresp.rt = []
        _pl1_instructions1_keyresp_allKeys = []
        # keep track of which components have finished
        pl1_instructions_1Components = [pl1_instructions1_img, pl1_instructions1_keyresp]
        for thisComponent in pl1_instructions_1Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "pl1_instructions_1" ---
        routineForceEnded = not continueRoutine
        while continueRoutine:
            # get current time
            t = routineTimer.getTime()
            ...
            # if pl1_instructions1_img is starting this frame...
            if pl1_instructions1_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl1_instructions1_img.frameNStart = frameN  # exact frame index
                pl1_instructions1_img.tStart = t  # local t and not account for scr refresh
                pl1_instructions1_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl1_instructions1_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl1_instructions1_img.status = STARTED
                pl1_instructions1_img.setAutoDraw(True)
            
            # if pl1_instructions1_img is active this frame...
            if pl1_instructions1_img.status == STARTED:
                # update params
                pass
            
            # *pl1_instructions1_keyresp* updates
            
            # if pl1_instructions1_keyresp is starting this frame...
            if pl1_instructions1_keyresp.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl1_instructions1_keyresp.frameNStart = frameN  # exact frame index
                pl1_instructions1_keyresp.tStart = t  # local t and not account for scr refresh
                pl1_instructions1_keyresp.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl1_instructions1_keyresp, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl1_instructions1_keyresp.status = STARTED
                # keyboard checking is just starting
                pl1_instructions1_keyresp.clock.reset()  # now t=0
                pl1_instructions1_keyresp.clearEvents(eventType='keyboard')
            if pl1_instructions1_keyresp.status == STARTED:
                theseKeys = pl1_instructions1_keyresp.getKeys(keyList=['y','n','left','right','space'], ignoreKeys=["escape"], waitRelease=False)
                _pl1_instructions1_keyresp_allKeys.extend(theseKeys)
                if len(_pl1_instructions1_keyresp_allKeys):
                    pl1_instructions1_keyresp.keys = _pl1_instructions1_keyresp_allKeys[-1].name  # just the last key pressed
                    pl1_instructions1_keyresp.rt = _pl1_instructions1_keyresp_allKeys[-1].rt
                    pl1_instructions1_keyresp.duration = _pl1_instructions1_keyresp_allKeys[-1].duration
                    # a response ends the routine
                    continueRoutine = False
        ...
        for thisComponent in pl1_instructions_1Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if pl1_instructions1_keyresp.keys in ['', [], None]:  # No response was made
            pl1_instructions1_keyresp.keys = None
        show_trials.addData('pl1_instructions1_keyresp.keys',pl1_instructions1_keyresp.keys)
        if pl1_instructions1_keyresp.keys != None:  # we had a response
            show_trials.addData('pl1_instructions1_keyresp.rt', pl1_instructions1_keyresp.rt)
            show_trials.addData('pl1_instructions1_keyresp.duration', pl1_instructions1_keyresp.duration)
        ...
        continueRoutine = True
        # update component parameters for each repeat
        pl1_instructions2_keyresp.keys = []
        pl1_instructions2_keyresp.rt = []
        _pl1_instructions2_keyresp_allKeys = []
        # keep track of which components have finished
        pl1_instructions_2Components = [pl1_instructions2_img, pl1_instructions2_keyresp]
        for thisComponent in pl1_instructions_2Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "pl1_instructions_2" ---
        routineForceEnded = not continueRoutine
        while continueRoutine:
            # get current time
            t = routineTimer.getTime()
            ...
            # if pl1_instructions2_img is starting this frame...
            if pl1_instructions2_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl1_instructions2_img.frameNStart = frameN  # exact frame index
                pl1_instructions2_img.tStart = t  # local t and not account for scr refresh
                pl1_instructions2_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl1_instructions2_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl1_instructions2_img.status = STARTED
                pl1_instructions2_img.setAutoDraw(True)
            
            # if pl1_instructions2_img is active this frame...
            if pl1_instructions2_img.status == STARTED:
                # update params
                pass
            
            # *pl1_instructions2_keyresp* updates
            
            # if pl1_instructions2_keyresp is starting this frame...
            if pl1_instructions2_keyresp.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl1_instructions2_keyresp.frameNStart = frameN  # exact frame index
                pl1_instructions2_keyresp.tStart = t  # local t and not account for scr refresh
                pl1_instructions2_keyresp.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl1_instructions2_keyresp, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl1_instructions2_keyresp.status = STARTED
                # keyboard checking is just starting
                pl1_instructions2_keyresp.clock.reset()  # now t=0
                pl1_instructions2_keyresp.clearEvents(eventType='keyboard')
            if pl1_instructions2_keyresp.status == STARTED:
                theseKeys = pl1_instructions2_keyresp.getKeys(keyList=['y','n','left','right','space'], ignoreKeys=["escape"], waitRelease=False)
                _pl1_instructions2_keyresp_allKeys.extend(theseKeys)
                if len(_pl1_instructions2_keyresp_allKeys):
                    pl1_instructions2_keyresp.keys = _pl1_instructions2_keyresp_allKeys[-1].name  # just the last key pressed
                    pl1_instructions2_keyresp.rt = _pl1_instructions2_keyresp_allKeys[-1].rt
                    pl1_instructions2_keyresp.duration = _pl1_instructions2_keyresp_allKeys[-1].duration
                    # a response ends the routine
                    continueRoutine = False
        ...
        for thisComponent in pl1_instructions_2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if pl1_instructions2_keyresp.keys in ['', [], None]:  # No response was made
            pl1_instructions2_keyresp.keys = None
        show_trials.addData('pl1_instructions2_keyresp.keys',pl1_instructions2_keyresp.keys)
        if pl1_instructions2_keyresp.keys != None:  # we had a response
            show_trials.addData('pl1_instructions2_keyresp.rt', pl1_instructions2_keyresp.rt)
            show_trials.addData('pl1_instructions2_keyresp.duration', pl1_instructions2_keyresp.duration)
        ...
        continueRoutine = True
        # update component parameters for each repeat
        pl1_instructions3_keyresp.keys = []
        pl1_instructions3_keyresp.rt = []
        _pl1_instructions3_keyresp_allKeys = []
        # keep track of which components have finished
        pl1_instructions_3Components = [pl1_instructions3_img, pl1_instructions3_keyresp]
        for thisComponent in pl1_instructions_3Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "pl1_instructions_3" ---
        routineForceEnded = not continueRoutine
        while continueRoutine:
            # get current time
            t = routineTimer.getTime()
            ...
            # if pl1_instructions3_img is starting this frame...
            if pl1_instructions3_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl1_instructions3_img.frameNStart = frameN  # exact frame index
                pl1_instructions3_img.tStart = t  # local t and not account for scr refresh
                pl1_instructions3_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl1_instructions3_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl1_instructions3_img.status = STARTED
                pl1_instructions3_img.setAutoDraw(True)
            
            # if pl1_instructions3_img is active this frame...
            if pl1_instructions3_img.status == STARTED:
                # update params
                pass
            
            # *pl1_instructions3_keyresp* updates
            
            # if pl1_instructions3_keyresp is starting this frame...
            if pl1_instructions3_keyresp.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl1_instructions3_keyresp.frameNStart = frameN  # exact frame index
                pl1_instructions3_keyresp.tStart = t  # local t and not account for scr refresh
                pl1_instructions3_keyresp.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl1_instructions3_keyresp, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl1_instructions3_keyresp.status = STARTED
                # keyboard checking is just starting
                pl1_instructions3_keyresp.clock.reset()  # now t=0
                pl1_instructions3_keyresp.clearEvents(eventType='keyboard')
            if pl1_instructions3_keyresp.status == STARTED:
                theseKeys = pl1_instructions3_keyresp.getKeys(keyList=['y','n','left','right','space'], ignoreKeys=["escape"], waitRelease=False)
                _pl1_instructions3_keyresp_allKeys.extend(theseKeys)
                if len(_pl1_instructions3_keyresp_allKeys):
                    pl1_instructions3_keyresp.keys = _pl1_instructions3_keyresp_allKeys[-1].name  # just the last key pressed
                    pl1_instructions3_keyresp.rt = _pl1_instructions3_keyresp_allKeys[-1].rt
                    pl1_instructions3_keyresp.duration = _pl1_instructions3_keyresp_allKeys[-1].duration
                    # a response ends the routine
                    continueRoutine = False
        ...
        for thisComponent in pl1_instructions_3Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if pl1_instructions3_keyresp.keys in ['', [], None]:  # No response was made
            pl1_instructions3_keyresp.keys = None
        show_trials.addData('pl1_instructions3_keyresp.keys',pl1_instructions3_keyresp.keys)
        if pl1_instructions3_keyresp.keys != None:  # we had a response
            show_trials.addData('pl1_instructions3_keyresp.rt', pl1_instructions3_keyresp.rt)
            show_trials.addData('pl1_instructions3_keyresp.duration', pl1_instructions3_keyresp.duration)
        ...
        continueRoutine = True
        # update component parameters for each repeat
        pl1_instructions4_keyresp.keys = []
        pl1_instructions4_keyresp.rt = []
        _pl1_instructions4_keyresp_allKeys = []
        # keep track of which components have finished
        pl1_instructions_4Components = [pl1_instructions4_img, pl1_instructions4_keyresp]
        for thisComponent in pl1_instructions_4Components:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        # --- Run Routine "pl1_instructions_4" ---
        routineForceEnded = not continueRoutine
        while continueRoutine:
            # get current time
            t = routineTimer.getTime()
            ...
            # if pl1_instructions4_img is starting this frame...
            if pl1_instructions4_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl1_instructions4_img.frameNStart = frameN  # exact frame index
                pl1_instructions4_img.tStart = t  # local t and not account for scr refresh
                pl1_instructions4_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl1_instructions4_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl1_instructions4_img.status = STARTED
                pl1_instructions4_img.setAutoDraw(True)
            
            # if pl1_instructions4_img is active this frame...
            if pl1_instructions4_img.status == STARTED:
                # update params
                pass
            
            # *pl1_instructions4_keyresp* updates
            
            # if pl1_instructions4_keyresp is starting this frame...
            if pl1_instructions4_keyresp.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl1_instructions4_keyresp.frameNStart = frameN  # exact frame index
                pl1_instructions4_keyresp.tStart = t  # local t and not account for scr refresh
                pl1_instructions4_keyresp.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl1_instructions4_keyresp, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl1_instructions4_keyresp.status = STARTED
                # keyboard checking is just starting
                pl1_instructions4_keyresp.clock.reset()  # now t=0
                pl1_instructions4_keyresp.clearEvents(eventType='keyboard')
            if pl1_instructions4_keyresp.status == STARTED:
                theseKeys = pl1_instructions4_keyresp.getKeys(keyList=['y','n','left','right','space'], ignoreKeys=["escape"], waitRelease=False)
                _pl1_instructions4_keyresp_allKeys.extend(theseKeys)
                if len(_pl1_instructions4_keyresp_allKeys):
                    pl1_instructions4_keyresp.keys = _pl1_instructions4_keyresp_allKeys[-1].name  # just the last key pressed
                    pl1_instructions4_keyresp.rt = _pl1_instructions4_keyresp_allKeys[-1].rt
                    pl1_instructions4_keyresp.duration = _pl1_instructions4_keyresp_allKeys[-1].duration
                    # a response ends the routine
                    continueRoutine = False
        ...
        for thisComponent in pl1_instructions_4Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        # check responses
        if pl1_instructions4_keyresp.keys in ['', [], None]:  # No response was made
            pl1_instructions4_keyresp.keys = None
        show_trials.addData('pl1_instructions4_keyresp.keys',pl1_instructions4_keyresp.keys)
        if pl1_instructions4_keyresp.keys != None:  # we had a response
            show_trials.addData('pl1_instructions4_keyresp.rt', pl1_instructions4_keyresp.rt)
            show_trials.addData('pl1_instructions4_keyresp.duration', pl1_instructions4_keyresp.duration)
        # the Routine "pl1_instructions_4" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        
        # set up handler to look after randomisation of conditions etc
        pl1_loop = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('pl1.xlsx'),
        ...
        for thisPl1_loop in pl1_loop:
            ...
            # keep track of which components have finished
            pl1_taskComponents = [pl1_task_lickert, pl1_task_confidence_lickert, pl1_task_stimLeft_img, pl1_task_stimRight_img, pl1_task_keyresp, pl1_task_fixation_txt]
            ...
            while continueRoutine:
                ...
                if pl1_task_lickert.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                # if pl1_task_confidence_lickert is starting this frame...
                if pl1_task_confidence_lickert.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                    pl1_task_confidence_lickert.frameNStart = frameN  # exact frame index
                    pl1_task_confidence_lickert.tStart = t  # local t and not account for scr refresh
                    pl1_task_confidence_lickert.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(pl1_task_confidence_lickert, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    pl1_task_confidence_lickert.status = STARTED
                    pl1_task_confidence_lickert.setAutoDraw(True)
                
                # if pl1_task_confidence_lickert is active this frame...
                if pl1_task_confidence_lickert.status == STARTED:
                    # update params
                    pass
                
                # *pl1_task_stimLeft_img* updates
                
                # if pl1_task_stimLeft_img is starting this frame...
                if pl1_task_stimLeft_img.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                    pl1_task_stimLeft_img.frameNStart = frameN  # exact frame index
                    pl1_task_stimLeft_img.tStart = t  # local t and not account for scr refresh
                    pl1_task_stimLeft_img.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(pl1_task_stimLeft_img, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    pl1_task_stimLeft_img.status = STARTED
                    pl1_task_stimLeft_img.setAutoDraw(True)
                
                # if pl1_task_stimLeft_img is active this frame...
                if pl1_task_stimLeft_img.status == STARTED:
                    # update params
                    pass
                
                # *pl1_task_stimRight_img* updates
                
                # if pl1_task_stimRight_img is starting this frame...
                if pl1_task_stimRight_img.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                    pl1_task_stimRight_img.frameNStart = frameN  # exact frame index
                    pl1_task_stimRight_img.tStart = t  # local t and not account for scr refresh
                    pl1_task_stimRight_img.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(pl1_task_stimRight_img, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    pl1_task_stimRight_img.status = STARTED
                    pl1_task_stimRight_img.setAutoDraw(True)
                
                # if pl1_task_stimRight_img is active this frame...
                if pl1_task_stimRight_img.status == STARTED:
                    # update params
                    pass
                ...
                if pl1_task_keyresp.status == NOT_STARTED and t >= .5-frameTolerance:
                    # keep track of start time/frame for later
            ...
            pl1_loop.addData('pl1_task_confidence_lickert.response', pl1_task_confidence_lickert.getRating())
            pl1_loop.addData('pl1_task_confidence_lickert.rt', pl1_task_confidence_lickert.getRT())
            # check responses
            ...
            if thisSession is not None:
                # if running in a Session with a Liaison client, send data up to now
                thisSession.sendExperimentData()
        # completed 1.0 repeats of 'pl1_loop'
        ...
        # keep track of which components have finished
        pl2_instructionsComponents = [pl2_instructions_img, pl2_instructions_keyresp]
        ...
        while continueRoutine:
            ...
            # if pl2_instructions_img is starting this frame...
            if pl2_instructions_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl2_instructions_img.frameNStart = frameN  # exact frame index
                pl2_instructions_img.tStart = t  # local t and not account for scr refresh
                pl2_instructions_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl2_instructions_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl2_instructions_img.status = STARTED
                pl2_instructions_img.setAutoDraw(True)
            
            # if pl2_instructions_img is active this frame...
            if pl2_instructions_img.status == STARTED:
                # update params
                pass
        ...
        show_trials.addData('pl2_instructions_keyresp.keys',pl2_instructions_keyresp.keys)
        if pl2_instructions_keyresp.keys != None:  # we had a response
            show_trials.addData('pl2_instructions_keyresp.rt', pl2_instructions_keyresp.rt)
            show_trials.addData('pl2_instructions_keyresp.duration', pl2_instructions_keyresp.duration)
        ...
        for thisPl2_loop in pl2_loop:
            ...
            # keep track of which components have finished
            pl2_taskComponents = [pl2_task_lickert, pl2_task_confidence_lickert, pl2_task_gnome_img, pl2_task_keyresp, pl2_task_forest_img, pl2_task_basket_img, pl2_task_fixation_txt]
            ...
            while continueRoutine:
                ...
                if pl2_task_lickert.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                # if pl2_task_confidence_lickert is starting this frame...
                if pl2_task_confidence_lickert.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                    pl2_task_confidence_lickert.frameNStart = frameN  # exact frame index
                    pl2_task_confidence_lickert.tStart = t  # local t and not account for scr refresh
                    pl2_task_confidence_lickert.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(pl2_task_confidence_lickert, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    pl2_task_confidence_lickert.status = STARTED
                    pl2_task_confidence_lickert.setAutoDraw(True)
                
                # if pl2_task_confidence_lickert is active this frame...
                if pl2_task_confidence_lickert.status == STARTED:
                    # update params
                    pass
                
                # *pl2_task_gnome_img* updates
                
                # if pl2_task_gnome_img is starting this frame...
                if pl2_task_gnome_img.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                    pl2_task_gnome_img.frameNStart = frameN  # exact frame index
                    pl2_task_gnome_img.tStart = t  # local t and not account for scr refresh
                    pl2_task_gnome_img.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(pl2_task_gnome_img, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    pl2_task_gnome_img.status = STARTED
                    pl2_task_gnome_img.setAutoDraw(True)
                
                # if pl2_task_gnome_img is active this frame...
                if pl2_task_gnome_img.status == STARTED:
                    # update params
                    pass
                ...
                if pl2_task_keyresp.status == NOT_STARTED and t >= 0.5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                # if pl2_task_forest_img is starting this frame...
                if pl2_task_forest_img.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                    pl2_task_forest_img.frameNStart = frameN  # exact frame index
                    pl2_task_forest_img.tStart = t  # local t and not account for scr refresh
                    pl2_task_forest_img.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(pl2_task_forest_img, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    pl2_task_forest_img.status = STARTED
                    pl2_task_forest_img.setAutoDraw(True)
                
                # if pl2_task_forest_img is active this frame...
                if pl2_task_forest_img.status == STARTED:
                    # update params
                    pass
                
                # *pl2_task_basket_img* updates
                
                # if pl2_task_basket_img is starting this frame...
                if pl2_task_basket_img.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                    pl2_task_basket_img.frameNStart = frameN  # exact frame index
                    pl2_task_basket_img.tStart = t  # local t and not account for scr refresh
                    pl2_task_basket_img.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(pl2_task_basket_img, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    pl2_task_basket_img.status = STARTED
                    pl2_task_basket_img.setAutoDraw(True)
                
                # if pl2_task_basket_img is active this frame...
                if pl2_task_basket_img.status == STARTED:
                    # update params
                    pass
            ...
            pl2_loop.addData('pl2_task_confidence_lickert.response', pl2_task_confidence_lickert.getRating())
            pl2_loop.addData('pl2_task_confidence_lickert.rt', pl2_task_confidence_lickert.getRT())
            # check responses
        ...
        # keep track of which components have finished
        pl3_instructionsComponents = [pl3_instructions_img, pl3_instructions_keyresp]
        ...
        while continueRoutine:
            ...
            # *pl3_instructions_img* updates
            
            # if pl3_instructions_img is starting this frame...
            if pl3_instructions_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl3_instructions_img.frameNStart = frameN  # exact frame index
                pl3_instructions_img.tStart = t  # local t and not account for scr refresh
                pl3_instructions_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl3_instructions_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl3_instructions_img.status = STARTED
                pl3_instructions_img.setAutoDraw(True)
            
            # if pl3_instructions_img is active this frame...
            if pl3_instructions_img.status == STARTED:
                # update params
                pass
        ...
        show_trials.addData('pl3_instructions_keyresp.keys',pl3_instructions_keyresp.keys)
        if pl3_instructions_keyresp.keys != None:  # we had a response
            show_trials.addData('pl3_instructions_keyresp.rt', pl3_instructions_keyresp.rt)
            show_trials.addData('pl3_instructions_keyresp.duration', pl3_instructions_keyresp.duration)
        ...
        for thisPl3_loop in pl3_loop:
            ...
            pl3_task_confidence_lickert.reset()
            # keep track of which components have finished
            pl3_taskComponents = [pl3_task_fixation_txt, pl3_task_stimUp_txt, pl3_task_lickert, pl3_task_keyresp, pl3_task_stimLeftBg_img, pl3_task_stimRightBg_img, pl3_task_stimLeft_img, pl3_task_stimRight_img, pl3_task_confidence_lickert, pl3_task_confidence_txt]
            ...
            while continueRoutine:
                ...
                if pl3_task_stimUp_txt.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                if pl3_task_lickert.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                if pl3_task_keyresp.status == NOT_STARTED and t >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                if pl3_task_stimLeftBg_img.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                if pl3_task_stimRightBg_img.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                if pl3_task_stimLeft_img.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                if pl3_task_stimRight_img.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                # *pl3_task_confidence_lickert* updates
                
                # if pl3_task_confidence_lickert is starting this frame...
                if pl3_task_confidence_lickert.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                    pl3_task_confidence_lickert.frameNStart = frameN  # exact frame index
                    pl3_task_confidence_lickert.tStart = t  # local t and not account for scr refresh
                    pl3_task_confidence_lickert.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(pl3_task_confidence_lickert, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    pl3_task_confidence_lickert.status = STARTED
                    pl3_task_confidence_lickert.setAutoDraw(True)
                
                # if pl3_task_confidence_lickert is active this frame...
                if pl3_task_confidence_lickert.status == STARTED:
                    # update params
                    pass
                
                # *pl3_task_confidence_txt* updates
                
                # if pl3_task_confidence_txt is starting this frame...
                if pl3_task_confidence_txt.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                    pl3_task_confidence_txt.frameNStart = frameN  # exact frame index
                    pl3_task_confidence_txt.tStart = t  # local t and not account for scr refresh
                    pl3_task_confidence_txt.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(pl3_task_confidence_txt, 'tStartRefresh')  # time at next scr refresh
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'pl3_task_confidence_txt.started')
                    # update status
                    pl3_task_confidence_txt.status = STARTED
                    pl3_task_confidence_txt.setAutoDraw(True)
                
                # if pl3_task_confidence_txt is active this frame...
                if pl3_task_confidence_txt.status == STARTED:
                    # update params
                    pass
            ...
            pl3_loop.addData('pl3_task_confidence_lickert.response', pl3_task_confidence_lickert.getRating())
            pl3_loop.addData('pl3_task_confidence_lickert.rt', pl3_task_confidence_lickert.getRT())
        ...
        # keep track of which components have finished
        pl4_instructionsComponents = [pl4_instructions_img, pl4_instructions_keyresp]
        ...
        while continueRoutine:
            ...
            # *pl4_instructions_img* updates
            
            # if pl4_instructions_img is starting this frame...
            if pl4_instructions_img.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                pl4_instructions_img.frameNStart = frameN  # exact frame index
                pl4_instructions_img.tStart = t  # local t and not account for scr refresh
                pl4_instructions_img.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(pl4_instructions_img, 'tStartRefresh')  # time at next scr refresh
                # update status
                pl4_instructions_img.status = STARTED
                pl4_instructions_img.setAutoDraw(True)
            
            # if pl4_instructions_img is active this frame...
            if pl4_instructions_img.status == STARTED:
                # update params
                pass
        ...
        show_trials.addData('pl4_instructions_keyresp.keys',pl4_instructions_keyresp.keys)
        if pl4_instructions_keyresp.keys != None:  # we had a response
            show_trials.addData('pl4_instructions_keyresp.rt', pl4_instructions_keyresp.rt)
            show_trials.addData('pl4_instructions_keyresp.duration', pl4_instructions_keyresp.duration)
        ...
        for thisPl4_loop in pl4_loop:
            ...
            pl4_task_confidence_lickert.reset()
            # keep track of which components have finished
            pl4_taskComponents = [pl4_task_stimUp_txt, pl4_task_fixation_txt, pl4_task_lickert, pl4_task_keyresp, pl4_task_stimLeft_img, pl4_task_stimRight_img, pl4_task_confidence_lickert, pl4_task_confidence_txt]
            ...
            while continueRoutine:
                ...
                if pl4_task_stimUp_txt.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                if pl4_task_lickert.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                if pl4_task_keyresp.status == NOT_STARTED and t >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                if pl4_task_stimLeft_img.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                if pl4_task_stimRight_img.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                ...
                # *pl4_task_confidence_lickert* updates
                
                # if pl4_task_confidence_lickert is starting this frame...
                if pl4_task_confidence_lickert.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                    pl4_task_confidence_lickert.frameNStart = frameN  # exact frame index
                    pl4_task_confidence_lickert.tStart = t  # local t and not account for scr refresh
                    pl4_task_confidence_lickert.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(pl4_task_confidence_lickert, 'tStartRefresh')  # time at next scr refresh
                    # update status
                    pl4_task_confidence_lickert.status = STARTED
                    pl4_task_confidence_lickert.setAutoDraw(True)
                
                # if pl4_task_confidence_lickert is active this frame...
                if pl4_task_confidence_lickert.status == STARTED:
                    # update params
                    pass
                
                # *pl4_task_confidence_txt* updates
                
                # if pl4_task_confidence_txt is starting this frame...
                if pl4_task_confidence_txt.status == NOT_STARTED and tThisFlip >= .5-frameTolerance:
                    # keep track of start time/frame for later
                    pl4_task_confidence_txt.frameNStart = frameN  # exact frame index
                    pl4_task_confidence_txt.tStart = t  # local t and not account for scr refresh
                    pl4_task_confidence_txt.tStartRefresh = tThisFlipGlobal  # on global time
                    win.timeOnFlip(pl4_task_confidence_txt, 'tStartRefresh')  # time at next scr refresh
                    # add timestamp to datafile
                    thisExp.timestampOnFlip(win, 'pl4_task_confidence_txt.started')
                    # update status
                    pl4_task_confidence_txt.status = STARTED
                    pl4_task_confidence_txt.setAutoDraw(True)
                
                # if pl4_task_confidence_txt is active this frame...
                if pl4_task_confidence_txt.status == STARTED:
                    # update params
                    pass
            ...
            pl4_loop.addData('pl4_task_confidence_lickert.response', pl4_task_confidence_lickert.getRating())
            pl4_loop.addData('pl4_task_confidence_lickert.rt', pl4_task_confidence_lickert.getRT())
        ...
        # keep track of which components have finished
        endComponents = [end_txt, end_keyresp]
        ...
        while continueRoutine:
            ...
            if end_keyresp.status == NOT_STARTED and t >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                ...
                # keyboard checking is just starting
                end_keyresp.clock.reset()  # now t=0
                end_keyresp.clearEvents(eventType='keyboard')
        ...
        show_trials.addData('end_keyresp.keys',end_keyresp.keys)
        if end_keyresp.keys != None:  # we had a response
            show_trials.addData('end_keyresp.rt', end_keyresp.rt)
            show_trials.addData('end_keyresp.duration', end_keyresp.duration)
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed flag_consent repeats of 'show_trials'
    
    
    # set up handler to look after randomisation of conditions etc
    show_no_consent = data.TrialHandler(nReps=flag_no_consent, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=[None],
        seed=None, name='show_no_consent')
    thisExp.addLoop(show_no_consent)  # add the loop to the experiment
    thisShow_no_consent = show_no_consent.trialList[0]  # so we can initialise stimuli with some values
    # abbreviate parameter names if possible (e.g. rgb = thisShow_no_consent.rgb)
    if thisShow_no_consent != None:
        for paramName in thisShow_no_consent:
            globals()[paramName] = thisShow_no_consent[paramName]
    
    for thisShow_no_consent in show_no_consent:
        currentLoop = show_no_consent
        thisExp.timestampOnFlip(win, 'thisRow.t')
        # pause experiment here if requested
        if thisExp.status == PAUSED:
            pauseExperiment(
        ...
        # update component parameters for each repeat
        # keep track of which components have finished
        no_consent_screenComponents = [no_consent_txt]
        for thisComponent in no_consent_screenComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine:
            ...
            # if no_consent_txt is starting this frame...
            if no_consent_txt.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
                # keep track of start time/frame for later
                no_consent_txt.frameNStart = frameN  # exact frame index
                no_consent_txt.tStart = t  # local t and not account for scr refresh
                no_consent_txt.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(no_consent_txt, 'tStartRefresh')  # time at next scr refresh
                # update status
                no_consent_txt.status = STARTED
                no_consent_txt.setAutoDraw(True)
            
            # if no_consent_txt is active this frame...
            if no_consent_txt.status == STARTED:
                # update params
                pass
        ...
        if thisSession is not None:
            # if running in a Session with a Liaison client, send data up to now
            thisSession.sendExperimentData()
    # completed flag_no_consent repeats of 'show_no_consent'
